# Abstract-Screening Design Decisions

This is the Stage 05 (abstract) screening design document. The previous stage (Stage 04, title screening) design decisions are partially inherited and partially revised in light of the richer text available at the abstract level.

## 2. Architectural deltas vs title screening
