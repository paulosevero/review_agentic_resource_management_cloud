...
authors: ["Azarkasb, Seyed Omid", "Khasteh, Seyed Hossein"]
year: 2026
venue: "Computing"
venue_type: "journal"
...
publisher: "Springer"
pages: ""
keywords: ["Cross-domain policy transfer", "Eligibility traces", "Exponential Random Graph Models (ERGM)", "Federated reinforcement learning", "Fog computing", "Influential nodes", "Multi-Kernel Fuzzy Clustering (MKFC)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Azarkasb, Seyed Omid and Khasteh, Seyed Hossein
- **Year:** 2026
- **Venue:** Computing
- **DOI:** 10.1007/s00607-025-01595-9
- **URL:** https://www.scopus.com/pages/publications/105031493413?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Enhanced federated reinforcement learning framework for task management in fog computing using eligibility traces and targeted model dissemination
