...
authors: ["Ali, Moazam", "Bagchi, Susmit"]
year: 2019
...
pages: "3464--3489"
keywords: ["Cloud computing", "Distributed systems", "Load monitoring", "Mobile agents", "Resource utilization"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-107 — Design and analysis of distributed load management: Mobile agent based probabilistic model and fuzzy integrated model

## Metadata

- **Authors:** Ali, Moazam and Bagchi, Susmit
- **Year:** 2019
- **Venue:** Applied Intelligence
- **DOI:** 10.1007/s10489-019-01454-z
- **URL:** https://www.scopus.com/pages/publications/85064522998?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Design and analysis of distributed load management: Mobile agent based probabilistic model and fuzzy integrated model
