...
authors: ["Ji, Zhang", "Guoliang, Qi", "Chunhong, Duo", "Wenwen, Gong"]
year: 2024
...
pages: "301--310"
keywords: ["hybrid action space", "Internet of things (IoT)", "mobile edge computing", "multi-agent deep determination policy gradient (MADDPG)"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
# paper-966 — Multi-Device Edge Computing Offload Method in Hybrid Action Space; [混合动作空间下的多设备边缘计算卸载方法]

## Metadata

- **Authors:** Ji, Zhang and Guoliang, Qi and Chunhong, Duo and Wenwen, Gong
- **Year:** 2024
- **Venue:** Computer Engineering and Applications
- **DOI:** 10.3778/j.issn.1002-8331.2304-0194
- **URL:** https://www.scopus.com/pages/publications/105007344161?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Multi-Device Edge Computing Offload Method in Hybrid Action Space; [混合动作空间下的多设备边缘计算卸载方法]
