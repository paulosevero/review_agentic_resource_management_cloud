...
authors: ["Dev, Kapal", "Khowaja, Sunder Ali", "Zeydan, Engin", "Singh, Keshav", "Debbah, Merouane"]
year: 2025
...
pages: ""
keywords: ["Energy efficiency", "Energy utilization", "Green computing", "Intelligent agents", "Network architecture", "Next generation networks", "Real time control", "Advanced architecture", "Architectural innovation", "Control planes", "Cutting edge technology", "Network operations", "New services", "Operational expenditures", "Service modeling", "Technology innovation", "User planes", "Wireless networks"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Dev, Kapal and Khowaja, Sunder Ali and Zeydan, Engin and Singh, Keshav and Debbah, Merouane
- **Year:** 2025
- **Venue:** IEEE Communications Standards Magazine
- **DOI:** 10.1109/MCOMSTD.2025.3632205
- **URL:** https://www.scopus.com/pages/publications/105022695036?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Advanced Architectures Integrated With Agentic AI for Next-Generation Wireless Networks
