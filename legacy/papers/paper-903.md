...
authors: ["Fan, Chenchen", "Xu, Hongyu", "Wang, Qingling"]
year: 2024
...
pages: ""
keywords: ["Counterfactual inference", "Deep reinforcement learning", "Mobile edge computing", "Unmanned aerial vehicle", "Whale optimization algorithm"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-903 — Multi-agent deep reinforcement learning for trajectory planning in UAVs-assisted mobile edge computing with heterogeneous requirements

## Metadata

- **Authors:** Fan, Chenchen and Xu, Hongyu and Wang, Qingling
- **Year:** 2024
- **Venue:** Computer Networks
- **DOI:** 10.1016/j.comnet.2024.110469
- **URL:** https://www.scopus.com/pages/publications/85192316615?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Multi-agent deep reinforcement learning for trajectory planning in UAVs-assisted mobile edge computing with heterogeneous requirements
