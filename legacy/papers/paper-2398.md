...
authors: ["Yuan, Xiao-Ming", "Tian, Han-Sen", "Huang, Kun-Da", "Deng, Qing-Xu", "Kang, Jia-Wen", "Li, Chang-Le", "Duan, Xu-Ting"]
year: 2025
...
pages: "1763--1780"
keywords: ["digital twin", "edge-based large models", "federated learning", "generative adversarial network", "mobile edge computing", "multi-agent deep reinforcement learning"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
- **Authors:** Yuan, Xiao-Ming and Tian, Han-Sen and Huang, Kun-Da and Deng, Qing-Xu and Kang, Jia-Wen and Li, Chang-Le and Duan, Xu-Ting
- **Year:** 2025
- **Venue:** Jisuanji Xuebao/Chinese Journal of Computers
- **DOI:** 10.11897/SP.J.1016.2025.01763
- **URL:** https://www.scopus.com/pages/publications/105014141998?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** A GAN-Enhanced Multi-Agent Deep Reinforcement Learning for Digital Twin-Driven Edge Inference and Heterogeneous Resource Co-Optimization; [数字孪生架构下基于 GAN 增强的多智能体深度强化学习边缘推理与异构资源协同优化]
