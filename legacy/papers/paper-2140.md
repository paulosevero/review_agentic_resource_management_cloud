...
pages: "202--208"
keywords: ["5G base station clusters,task offloading,Multi-Agent Reinforcement Learning (MARL),edge computing"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Si, Peishuo and Li, Yufeng
- **Year:** 2025
- **Venue:** 2025 International Conference on Aerospace Information Perception and Intelligent Processing, AIPIP 2025
- **DOI:** 10.1109/AIPIP66876.2025.11299202
- **URL:** https://www.scopus.com/pages/publications/105032063306?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** A low-complexity task offloading algorithm for 5G base station energy conservation based on multi-agent reinforcement learning
