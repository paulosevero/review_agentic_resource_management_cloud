...
authors: ["Pokhrel, Shiva Raj", "Walid, Anwar"]
year: 2023
...
pages: "996--1009"
keywords: ["access traffic steering switching splitting (ATSSS)", "deep Q-learning", "Multipath TCP", "stability analysis"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-696 — Learning to Harness Bandwidth with Multipath Congestion Control and Scheduling

## Metadata

- **Authors:** Pokhrel, Shiva Raj and Walid, Anwar
- **Year:** 2023
- **Venue:** IEEE Transactions on Mobile Computing
- **DOI:** 10.1109/TMC.2021.3085598
- **URL:** https://www.scopus.com/pages/publications/85107343246?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Learning to Harness Bandwidth with Multipath Congestion Control and Scheduling
