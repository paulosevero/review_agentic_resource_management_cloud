...
authors: ["Jing, Chuanfang", "Zhu, Xiaorong"]
year: 2025
...
pages: "118--133"
keywords: ["6G network", "AI inference service", "hypergraph", "multi-dimensional resource", "orchestration and scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Jing, Chuanfang and Zhu, Xiaorong
- **Year:** 2025
- **Venue:** Tongxin Xuebao/Journal on Communications
- **DOI:** 10.11959/j.issn.1000-436x.2025180
- **URL:** https://www.scopus.com/pages/publications/105023446987?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Multi-dimensional resource orchestration and scheduling method driven by AI inference services via hypergraph and genetic algorithm; [基于超图和遗传算法的 AI 推理服务驱动的多维资源编排与调度方法]
