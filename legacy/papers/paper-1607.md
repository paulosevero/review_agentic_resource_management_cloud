...
pages: ""
keywords: ["Community resilience", "Digital twin", "Dynamic optimization", "Reinforcement learning", "Rural smart elderly care"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Backscatter communication and multi-agent reinforcement learning enable low-power digital twin system for rural elderly care
