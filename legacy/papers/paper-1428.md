...
pages: ""
keywords: ["AI inference", "ant colony optimization", "cloud computing", "load balancing", "swarm intelligence"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Swarm Intelligence for AI/ML Workload in Distributed Cloud Infrastructure
