...
authors: ["Ning, Jiahong", "Zhu, Pengyan", "Zheng, Ce", "Lee, Gary", "Sun, Sumei", "Yang, Tingting"]
year: 2025
...
pages: ""
keywords: ["EdgePrompt", "Key-value pair (KV pair)", "Large Language Models (LLMs)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Ning, Jiahong and Zhu, Pengyan and Zheng, Ce and Lee, Gary and Sun, Sumei and Yang, Tingting
- **Year:** 2025
- **Venue:** IEEE Conference on Computer Communications Workshops, INFOCOM WKSHPS 2025
- **DOI:** 10.1109/INFOCOMWKSHPS65812.2025.11152752
- **URL:** https://www.scopus.com/pages/publications/105017961553?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** EdgePrompt: A Distributed Key-Value Inference Framework for LLMs in 6G Networks
