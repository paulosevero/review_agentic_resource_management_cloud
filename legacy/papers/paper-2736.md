...
authors: ["Pan, Fan", "Cui, Pengshuai", "Zhang, Jiaqi", "Pei, Jinchuan", "Song, Xuanyan", "Hu, Yuxiang", "Long, Keping"]
year: 2026
...
pages: ""
keywords: ["Cloud-network Convergence", "Graph Representation Learning", "Large Language Models", "Trust Evaluation"]
language: "English"
source:
  databases: ["Scopus"]
...
screening:
  "04-title-screening":
    ...
    human_justification: "Talvez o fato de ter um \"language-augmented\" indique uso de LLM+GNN"
...
- **Authors:** Pan, Fan and Cui, Pengshuai and Zhang, Jiaqi and Pei, Jinchuan and Song, Xuanyan and Hu, Yuxiang and Long, Keping
- **Year:** 2026
- **Venue:** IEEE Transactions on Network Science and Engineering
- **DOI:** 10.1109/TNSE.2026.3680408
- **URL:** https://www.scopus.com/pages/publications/105034815478?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** LAGTrust: Language-Augmented Graph Representation Learning for Trust Evaluation in Cloud-Network Convergence
