...
authors: ["Wang, Binyang", "Li, Huifang", "Lin, Zhiwei", "Xia, Yuanqing"]
year: 2020
...
# paper-244 — Temporal Fusion Pointer network-based Reinforcement Learning algorithm for Multi-Objective Workflow Scheduling in the cloud

## Metadata

- **Authors:** Wang, Binyang and Li, Huifang and Lin, Zhiwei and Xia, Yuanqing
- **Year:** 2020
- **Venue:** Proceedings of the International Joint Conference on Neural Networks
- **DOI:** 10.1109/IJCNN48605.2020.9207151
- **URL:** https://www.scopus.com/pages/publications/85093816795?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Temporal Fusion Pointer network-based Reinforcement Learning algorithm for Multi-Objective Workflow Scheduling in the cloud
