...
pages: ""
keywords: ["computation offloading", "integrated space\u2013air\u2013marine network", "MADDPG", "mobile edge computing", "resource allocation"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Research on Computation Offloading and Resource Allocation Strategy Based on MADDPG for Integrated Space–Air–Marine Network
