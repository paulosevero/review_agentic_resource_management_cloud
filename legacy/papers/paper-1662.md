...
authors: ["Hu, Yuntao", "Chen, Ming", "Sun, Haowen", "Wang, Yinlu", "Cang, Yihan"]
year: 2025
venue: "IEEE Access"
venue_type: "journal"
...
pages: "118933--118943"
keywords: ["centralized training and decentralized execution (CTDE)", "embedding method", "Long-term multi-cell MEC systems", "multi-agent deep reinforcement learning (MADRL)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Hu, Yuntao and Chen, Ming and Sun, Haowen and Wang, Yinlu and Cang, Yihan
- **Year:** 2025
- **Venue:** IEEE Access
- **DOI:** 10.1109/ACCESS.2025.3584471
- **URL:** https://www.scopus.com/pages/publications/105009978077?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Joint Optimization of Resource Allocation and Task Offloading Strategies in Multi-Cell Dynamic MEC Systems Using Multi-Agent DRL
