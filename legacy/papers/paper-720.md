...
pages: "7333--7349"
keywords: ["cooling system", "data center", "deep reinforcement learning", "Energy consumption", "job scheduling", "multi-agent system"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-720 — Research on overall energy consumption optimization method for data center based on deep reinforcement learning

## Metadata

- **Authors:** Simin, Wang and Lulu, Qin and Chunmiao, Ma and Weiguo, Wu
- **Year:** 2023
- **Venue:** Journal of Intelligent and Fuzzy Systems
- **DOI:** 10.3233/JIFS-223769
- **URL:** https://www.scopus.com/pages/publications/85166388656?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Research on overall energy consumption optimization method for data center based on deep reinforcement learning
