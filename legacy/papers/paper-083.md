...
screening:
  "04-title-screening":
    ...
    human_justification: "Swarm intelligence + KDE"

---

# paper-083 — A negotiation-based service selection approach using swarm intelligence and kernel density estimation

## Metadata

- **Authors:** Mezni, Haithem and Sellami, Mokhtar
- **Year:** 2018
- **Venue:** Software - Practice and Experience
- **DOI:** 10.1002/spe.2575
- **URL:** https://www.scopus.com/pages/publications/85046729866?origin=resultslist
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** A negotiation-based service selection approach using swarm intelligence and kernel density estimation
