...
pages: "2565--2578"
keywords: ["Distributed", "multi-access edge computing", "multi-agent reinforcement learning", "multi-cloud"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-367 — Distributed Multi-Cloud Multi-Access Edge Computing by Multi-Agent Reinforcement Learning
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Distributed Multi-Cloud Multi-Access Edge Computing by Multi-Agent Reinforcement Learning
