...
authors: ["Arzo, Sisay Tadesse", "Esmaeili, Mona", "Worku, Yonatan Melese", "Akhavan, Zeinab", "Devetsikiotis, Michael", "Zarkesh-Ha, Payman"]
year: 2022
...
pages: "4413--4418"
keywords: ["Autonomous agents", "Computer system firewalls", "Deep learning", "Forecasting", "Intelligent agents", "Multi agent systems", "Network architecture", "Agent based", "Cloud data centers", "Decision accuracies", "Decision-based", "Edge clouds", "In networks", "Multi agent", "Network automations", "Network intelligence", "Networks management", "State feedback"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-383 — Proactive and Reactive Decision Based Agent Placement: Reliability and Latency Perspective

## Metadata

- **Authors:** Arzo, Sisay Tadesse and Esmaeili, Mona and Worku, Yonatan Melese and Akhavan, Zeinab and Devetsikiotis, Michael and Zarkesh-Ha, Payman
- **Year:** 2022
- **Venue:** Proceedings - IEEE Global Communications Conference, GLOBECOM
- **DOI:** 10.1109/GLOBECOM48099.2022.10001516
- **URL:** https://www.scopus.com/pages/publications/85146923459?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Proactive and Reactive Decision Based Agent Placement: Reliability and Latency Perspective
