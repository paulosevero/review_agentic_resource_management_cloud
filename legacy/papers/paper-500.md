...
authors: ["Tuli, Shreshth", "Ilager, Shashikant", "Ramamohanarao, Kotagiri", "Buyya, Rajkumar"]
year: 2022
...
pages: "940--954"
keywords: ["asynchronous advantage actor-critic", "cloud computing", "deep reinforcement learning", "Edge computing", "recurrent neural network", "task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
screening:
  "04-title-screening":
    ...
    human_justification: "RL / RNN"

---

# paper-500 — Dynamic Scheduling for Stochastic Edge-Cloud Computing Environments Using A3C Learning and Residual Recurrent Neural Networks

## Metadata

- **Authors:** Tuli, Shreshth and Ilager, Shashikant and Ramamohanarao, Kotagiri and Buyya, Rajkumar
- **Year:** 2022
- **Venue:** IEEE Transactions on Mobile Computing
- **DOI:** 10.1109/TMC.2020.3017079
- **URL:** https://www.scopus.com/pages/publications/85124597565?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Dynamic Scheduling for Stochastic Edge-Cloud Computing Environments Using A3C Learning and Residual Recurrent Neural Networks
