...
authors: ["Filippini, Federica", "Lujak, Marin", "Ciavotta, Michele"]
year: 2026
...
pages: ""
keywords: ["Distributed optimization", "Edge\u2013Cloud continuum", "Function-as-a-Service", "Load balancing", "Multi-agent orchestration", "Privacy-preserving coordination"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Filippini, Federica and Lujak, Marin and Ciavotta, Michele
- **Year:** 2026
- **Venue:** Journal of Systems Architecture
- **DOI:** 10.1016/j.sysarc.2026.103787
- **URL:** https://www.scopus.com/pages/publications/105034568383?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Distributed replica allocation and load balancing for Edge–Cloud FaaS: A cooperative multi-agent orchestration approach
