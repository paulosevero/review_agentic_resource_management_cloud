...
authors: ["Panchal, Deven", "Verma, Prafulla", "Baran, Isilay", "Musgrove, Dan", "Lu, David"]
year: 2024
...
pages: "84--89"
keywords: ["5G", "6G", "Intent Driven Networking", "Intent-Based Networking", "Large Language Models (LLMs)", "Machine Learning", "Natural Language Processing", "Network Function Virtualization", "Network Orchestration", "Next Generation Networks", "Open Network Automation Platform (ONAP)", "Open Source", "Operations support systems (OSS)", "Software Defined Net-working"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Panchal, Deven and Verma, Prafulla and Baran, Isilay and Musgrove, Dan and Lu, David
- **Year:** 2024
- **Venue:** International Conference on Information Networking
- **DOI:** 10.1109/ICOIN59985.2024.10572160
- **URL:** https://www.scopus.com/pages/publications/85198366981?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Simplifying Network Orchestration using Conversational AI
