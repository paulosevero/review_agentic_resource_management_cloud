...
authors: ["Yongli, Zhao", "Huibin, Zhang", "Kunpeng, Zheng", "Wei, Wang", "Yuan, Cao", "Lihan, Zhao", "Jie, Zhang"]
year: 2025
...
pages: ""
keywords: ["netw ork architecture", "optical transport netw ork", "satellite laser com m unication", "the sixth generation fixed network"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
- **Authors:** Yongli, Zhao and Huibin, Zhang and Kunpeng, Zheng and Wei, Wang and Yuan, Cao and Lihan, Zhao and Jie, Zhang
- **Year:** 2025
- **Venue:** Guangxue Xuebao/Acta Optica Sinica
- **DOI:** 10.3788/AOS250873
- **URL:** https://www.scopus.com/pages/publications/105011256234?origin=resultslist
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** Architecture and Key Technologies of Large-Scale Space Optical Transport Networks (Invited); [大 规 模 空 间 光 传 送 网 架 构 与 关 键 技 术(特 邀)]
