...
authors: ["Luo, Haoxiang", "Liu, Yinqiu", "Zhang, Ruichen", "Wang, Jiacheng", "Sun, Gang", "Niyato, Dusit", "Yu, Hongfang", "Xiong, Zehui", "Wang, Xianbin", "Shen, Xuemin"]
year: 2025
...
pages: "3563--3585"
keywords: ["edge computing", "Large language model (LLM)", "multimodal LLM", "multiple LLMs", "trustworthy LLM system"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Luo, Haoxiang and Liu, Yinqiu and Zhang, Ruichen and Wang, Jiacheng and Sun, Gang and Niyato, Dusit and Yu, Hongfang and Xiong, Zehui and Wang, Xianbin and Shen, Xuemin
- **Year:** 2025
- **Venue:** IEEE Transactions on Cognitive Communications and Networking
- **DOI:** 10.1109/TCCN.2025.3612760
- **URL:** https://www.scopus.com/pages/publications/105017162849?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Toward Edge General Intelligence With Multiple-Large Language Model (Multi-LLM): Architecture, Trust, and Orchestration
