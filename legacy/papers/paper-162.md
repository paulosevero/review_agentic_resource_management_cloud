...
authors: ["Thilagavathi, N.", "Divya Dharani, D.", "Sasilekha, R.", "Suruliandi, Vasundhara", "Rhymend Uthariaraj, V."]
year: 2019
...
pages: "84--100"
keywords: ["Agent-based model", "Cloud computing", "Clustering", "Energy consumption", "Energy efficiency", "Load balancing", "Migration", "Server consolidation"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-162 — Energy efficient load balancing in cloud data center using clustering technique

## Metadata

- **Authors:** Thilagavathi, N. and Divya Dharani, D. and Sasilekha, R. and Suruliandi, Vasundhara and Rhymend Uthariaraj, V.
- **Year:** 2019
- **Venue:** International Journal of Intelligent Information Technologies
- **DOI:** 10.4018/IJIIT.2019010104
- **URL:** https://www.scopus.com/pages/publications/85060776073?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Energy efficient load balancing in cloud data center using clustering technique
