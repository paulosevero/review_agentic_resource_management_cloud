...
authors: ["Yang, Tingting", "Feng, Ping", "Guo, Qixin", "Zhang, Jindi", "Zhang, Xiufeng", "Ning, Jiahong", "Wang, Xinghan", "Mao, Zhongyang"]
year: 2025
...
pages: "987--998"
keywords: ["cloud computing", "communication coordination", "dynamic task allocation", "Generative AI", "heterogeneous multi-agent system (HMAS)", "large language model (LLM)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Yang, Tingting and Feng, Ping and Guo, Qixin and Zhang, Jindi and Zhang, Xiufeng and Ning, Jiahong and Wang, Xinghan and Mao, Zhongyang
- **Year:** 2025
- **Venue:** IEEE Transactions on Cognitive Communications and Networking
- **DOI:** 10.1109/TCCN.2025.3528892
- **URL:** https://www.scopus.com/pages/publications/105002485279?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** AutoHMA-LLM: Efficient Task Coordination and Execution in Heterogeneous Multi-Agent Systems Using Hybrid Large Language Models
