...
authors: ["Wang, Xiaoer", "Ding, Shuang", "Zhang, Guoqing"]
year: 2023
...
pages: "408--413"
keywords: ["multi-agent deep reinforcement learning", "task offloading", "Vehicle-edge computing"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-748 — MADDPG: A task offloading algorithm based on multi-agent deep reinforcement learning in vehicle-edge computing

## Metadata

- **Authors:** Wang, Xiaoer and Ding, Shuang and Zhang, Guoqing
- **Year:** 2023
- **Venue:** ACM International Conference Proceeding Series
- **DOI:** 10.1145/3640912.3640992
- **URL:** https://www.scopus.com/pages/publications/85186954116?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** MADDPG: A task offloading algorithm based on multi-agent deep reinforcement learning in vehicle-edge computing
