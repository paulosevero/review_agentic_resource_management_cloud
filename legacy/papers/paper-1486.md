...
authors: ["Cheng, Ming", "He, Saifei", "Pan, Yijin", "Lin, Min", "Zhu, Wei-Ping"]
year: 2025
venue: "Sensors"
venue_type: "journal"
...
pages: ""
keywords: ["closed-form enhanced multi-armed bandit (CF-MAB)", "energy consumption", "latency", "mobile edge computing (MEC)", "multi-agent proximal policy optimization (MAPPO)", "multi-UAV networks"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Cheng, Ming and He, Saifei and Pan, Yijin and Lin, Min and Zhu, Wei-Ping
- **Year:** 2025
- **Venue:** Sensors
- **DOI:** 10.3390/s25175234
- **URL:** https://www.scopus.com/pages/publications/105015894372?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Cooperative Schemes for Joint Latency and Energy Consumption Minimization in UAV-MEC Networks †
