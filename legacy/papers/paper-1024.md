...
authors: ["Li, Yang", "Zhu, Li", "Liu, Shichao", "Wang, Hongwei", "Yu, F. Richard", "Cai, Baigen"]
year: 2024
...
pages: "17384--17399"
keywords: ["Cooperative vehicle infrastructure", "cross-system two-level optimization", "electric vehicle cluster", "multi-tier VEC system"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Yang and Zhu, Li and Liu, Shichao and Wang, Hongwei and Yu, F. Richard and Cai, Baigen
- **Year:** 2024
- **Venue:** IEEE Transactions on Vehicular Technology
- **DOI:** 10.1109/TVT.2024.3430507
- **URL:** https://www.scopus.com/pages/publications/85199076584?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Electric Vehicle Cluster Assisted Multi-Tier Vehicular Edge Computing System: Cross-System Framework Design and Optimization
