...
authors: ["Huang, Shenquan", "Zhu, Xiaohui", "Chen, Zirui", "Li, Panfeng", "Yu, Luchuan"]
year: 2026
...
publisher: "CIMS"
pages: "772--785"
keywords: ["attention mechanism", "bidirectional sequence feature", "manufacturing cloud services", "service recommendation", "topic semantic model"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
- **Authors:** Huang, Shenquan and Zhu, Xiaohui and Chen, Zirui and Li, Panfeng and Yu, Luchuan
- **Year:** 2026
- **Venue:** Jisuanji Jicheng Zhizao Xitong/Computer Integrated Manufacturing Systems, CIMS
- **DOI:** 10.13196/j.cims.2023.0732
- **URL:** https://www.scopus.com/pages/publications/105033081557?origin=resultslist
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** Manufacturing service recommendation method based on bidirectional sequence feature and topic semantic model; [基于双向序列特征和主题语义模型的制造服务推荐方法]
