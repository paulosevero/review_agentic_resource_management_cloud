...
pages: "3003--3023"
keywords: ["Deep reinforcement learning", "Mobile edge computing", "Service caching", "Unmanned aerial vehicle", "Workload offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-982 — Medley deep reinforcement learning-based workload offloading and cache placement decision in UAV-enabled MEC networks
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Medley deep reinforcement learning-based workload offloading and cache placement decision in UAV-enabled MEC networks
