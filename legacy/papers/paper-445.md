...
authors: ["Karat, Chitharanjan", "Senthilkumar, Radha"]
year: 2022
...
pages: ""
keywords: ["Bioluminescence", "Cloud computing", "Learning algorithms", "Multi agent systems", "Network security", "Optimization", "Quality of service", "Reinforcement learning", "Resource allocation", "Virtual machine", "Cloud-computing", "Dynamic resource allocations", "Greedy adaptive firefly", "Multi agent", "Optimal resource allocation", "Quality-of-service", "Resource allocation schemes", "Resource allocation techniques", "Resource management techniques", "Resources allocation", "Deep learning"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-445 — Optimal resource allocation with deep reinforcement learning and greedy adaptive firefly algorithm in cloud computing

## Metadata

- **Authors:** Karat, Chitharanjan and Senthilkumar, Radha
- **Year:** 2022
- **Venue:** Concurrency and Computation: Practice and Experience
- **DOI:** 10.1002/cpe.6657
- **URL:** https://www.scopus.com/pages/publications/85116034454?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Optimal resource allocation with deep reinforcement learning and greedy adaptive firefly algorithm in cloud computing
