...
authors: ["Xu, Wei", "Yang, Zhaohui", "Ng, Derrick Wing Kwan", "Levorato, Marco", "Eldar, Yonina C.", "Debbah, Merouane"]
year: 2023
...
pages: "9--39"
keywords: ["Artificial intelligence (AI)", "beyond 5G (B5G)", "communication optimization", "deep learning (DL)", "edge learning (EL)", "federated learning (FL)", "Internet-of-Everything (IoE)", "multi-agent reinforcement learning (MARL)"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-764 — Edge Learning for B5G Networks With Distributed Signal Processing: Semantic Communication, Edge Computing, and Wireless Sensing

## Metadata

- **Authors:** Xu, Wei and Yang, Zhaohui and Ng, Derrick Wing Kwan and Levorato, Marco and Eldar, Yonina C. and Debbah, Merouane
- **Year:** 2023
- **Venue:** IEEE Journal on Selected Topics in Signal Processing
- **DOI:** 10.1109/JSTSP.2023.3239189
- **URL:** https://www.scopus.com/pages/publications/85147274563?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Edge Learning for B5G Networks With Distributed Signal Processing: Semantic Communication, Edge Computing, and Wireless Sensing
