...
authors: ["Yan, Junjie", "Wang, Wenli", "Liu, Jingxian", "Deng, Junyi", "Yuan, Haohao", "Zhu, Yaxin"]
year: 2025
...
pages: "1641--1655"
keywords: ["Mobile edge computing (MEC)", "multiagent deep deterministic policy gradient (MADDPG)", "Tabu search-based matching (TSM)", "unmanned aerial vehicles (UAVs)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Yan, Junjie and Wang, Wenli and Liu, Jingxian and Deng, Junyi and Yuan, Haohao and Zhu, Yaxin
- **Year:** 2025
- **Venue:** IEEE Sensors Journal
- **DOI:** 10.1109/JSEN.2024.3494028
- **URL:** https://www.scopus.com/pages/publications/85209732149?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Task Demand-Oriented Collaborative Offloading and Deployment Strategy in Software-Defined UAV-Assisted Edge Networks
