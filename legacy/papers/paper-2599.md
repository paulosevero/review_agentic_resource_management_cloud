...
publisher: "SPIE"
pages: ""
keywords: ["deep reinforcement learning", "dynamic resource allocation", "fairness-efficiency tradeoff", "management objectives", "Multi-agent systems"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Dynamic resource allocation for multiagent systems via deep reinforcement learning
