...
pages: "3845--3850"
keywords: ["cell-free massive MIMO", "deep reinforcement learning (DRL)", "edge computing", "joint communication and computing resource allocation", "multi-agent reinforcement learning"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-498 — DRL-based Distributed Resource Allocation for Edge Computing in Cell-Free Massive MIMO Network
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** DRL-based Distributed Resource Allocation for Edge Computing in Cell-Free Massive MIMO Network
