...
authors: ["Sun, Chuan", "Li, Xiuhua", "Wen, Junhao", "Wang, Xiaofei", "Han, Zhu", "Leung, Victor C. M."]
year: 2023
...
pages: "690--705"
keywords: ["discrete soft actor-critic", "federated learning", "Multi-tier computing", "recommendation-enabled edge caching", "soft hits"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-727 — Federated Deep Reinforcement Learning for Recommendation-Enabled Edge Caching in Mobile Edge-Cloud Computing Networks

## Metadata

- **Authors:** Sun, Chuan and Li, Xiuhua and Wen, Junhao and Wang, Xiaofei and Han, Zhu and Leung, Victor C. M.
- **Year:** 2023
- **Venue:** IEEE Journal on Selected Areas in Communications
- **DOI:** 10.1109/JSAC.2023.3235443
- **URL:** https://www.scopus.com/pages/publications/85147301164?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Federated Deep Reinforcement Learning for Recommendation-Enabled Edge Caching in Mobile Edge-Cloud Computing Networks
