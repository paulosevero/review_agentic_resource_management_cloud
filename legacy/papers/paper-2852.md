...
authors: ["Wu, Liangshun", "Tao, Tao", "Zhang, Bin", "Wang, Kezhi", "Du, Jianbo", "Qu, Junsuo"]
year: 2026
...
pages: ""
keywords: ["Mobile Edge Computing", "Multi-Agent Reinforcement Learning", "Reconfigurable Intelligent Surfaces", "Unmanned Aerial Vehicles"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Wu, Liangshun and Tao, Tao and Zhang, Bin and Wang, Kezhi and Du, Jianbo and Qu, Junsuo
- **Year:** 2026
- **Venue:** IEEE Transactions on Vehicular Technology
- **DOI:** 10.1109/TVT.2026.3666220
- **URL:** https://www.scopus.com/pages/publications/105030697217?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Model-Based Decentralized Joint Optimization of Resource Allocation, Phase Shift, and UAV Trajectory for Energy-Efficient RIS Assisted UAV-MEC Systems
