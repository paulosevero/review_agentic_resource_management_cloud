...
authors: ["Fan, Zhiyong", "Lin, Yuanmo", "Ai, Yuxun", "Xu, Hang"]
year: 2024
...
pages: ""
keywords: ["adult", "algorithm", "article", "awareness", "data processing", "decision making", "human", "interpersonal communication", "learning", "migration", "recycling", "resource allocation", "simulation", "workflow"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-902 — Adaptive task migration strategy with delay risk control and reinforcement learning for emergency monitoring

## Metadata

- **Authors:** Fan, Zhiyong and Lin, Yuanmo and Ai, Yuxun and Xu, Hang
- **Year:** 2024
- **Venue:** Scientific Reports
- **DOI:** 10.1038/s41598-024-67886-x
- **URL:** https://www.scopus.com/pages/publications/85200044958?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Adaptive task migration strategy with delay risk control and reinforcement learning for emergency monitoring
