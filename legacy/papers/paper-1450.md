...
authors: ["Castillo, Antonio Cort\u00e9s"]
year: 2025
...
pages: ""
keywords: ["artificial intelligence", "data centers", "deep learning", "generative artificial intelligence", "metrics", "neural networks"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Neural Network Architectures for Enhancing Data Center Intelligence through Deep Learning
