...
pages: "171--191"
keywords: ["Code Migration", "Docker", "Enterprise SaaS", "Generative AI", "Machine Learning", "Microservices", "Oracle Cloud Infrastructure"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Lift and Shift of Model Code Using Machine Learning Microservices with Generative AI Mapping Layer in Enterprise SaaS Applications
