...
authors: ["Zhang, Yongnan", "Zhou, Yonghua", "Fujita, Hamido"]
year: 2024
...
pages: "20715--20728"
keywords: ["Distributed multi-agent reinforcement learning", "graph convolutional network", "low-carbon control", "parallel optimization", "self-attention value decomposition", "traffic network flow"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zhang, Yongnan and Zhou, Yonghua and Fujita, Hamido
- **Year:** 2024
- **Venue:** IEEE Transactions on Intelligent Transportation Systems
- **DOI:** 10.1109/TITS.2024.3452430
- **URL:** https://www.scopus.com/pages/publications/85210925168?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Distributed Multi-Agent Reinforcement Learning for Cooperative Low-Carbon Control of Traffic Network Flow Using Cloud-Based Parallel Optimization
