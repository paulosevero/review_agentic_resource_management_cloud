...
authors: ["Dai, Yu", "Zhang, Qiuhong", "Yang, Lei"]
year: 2021
...
publisher: "MDPI"
pages: ""
keywords: ["Deep reinforcement learning", "Mobile edge computing", "Virtual machine migration"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-281 — Virtual machine migration strategy based on multi-agent deep reinforcement learning

## Metadata

- **Authors:** Dai, Yu and Zhang, Qiuhong and Yang, Lei
- **Year:** 2021
- **Venue:** Applied Sciences (Switzerland)
- **DOI:** 10.3390/app11177993
- **URL:** https://www.scopus.com/pages/publications/85114102333?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Virtual machine migration strategy based on multi-agent deep reinforcement learning
