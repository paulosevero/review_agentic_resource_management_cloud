...
# paper-0171 — An edge-Assisted vehicle routing method based on game-Theoretic multiagent learning
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0171.pdf`)_
