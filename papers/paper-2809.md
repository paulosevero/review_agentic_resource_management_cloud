...
screening:
  04-title-screening:
    ...
    my_justification: Model-Driven pode indicar LLM
...
# paper-2809 — Model-Driven Development of Chatbot Microservices
...
- **evidence_trail:**
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "Chatbot" }`
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "chatbots" }`
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "chatbot" }`
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "chatbot" }`
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "chatbots" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2809.pdf`)_
