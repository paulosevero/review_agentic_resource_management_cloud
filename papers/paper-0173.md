...
# paper-0173 — A New Multi-Agent Hybrid Marketplace for Cloud Resource Allocation
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0173.pdf`)_
