...
authors: ["Yun, Jusik", "Goh, Yunyeong", "Yoo, Wonsuk", "Chung, Jong-Moon"]
year: 2022
...
pages: "20733--20749"
keywords: ["5G", "deep reinforcement learning (DRL)", "distributed learning", "enhanced mobile broadband (eMBB)", "Internet of Things (IoT)", "multiaccess edge computing (MEC)", "multiradio access technology (RAT)", "offloading", "resource allocation", "ultrareliability low-latency communication (URLLC)"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-529 — 5G Multi-RAT URLLC and eMBB Dynamic Task Offloading With MEC Resource Allocation Using Distributed Deep Reinforcement Learning

## Metadata

- **Authors:** Yun, Jusik and Goh, Yunyeong and Yoo, Wonsuk and Chung, Jong-Moon
- **Year:** 2022
- **Venue:** IEEE Internet of Things Journal
- **DOI:** 10.1109/JIOT.2022.3177425
- **URL:** https://www.scopus.com/pages/publications/85130827435?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** 5G Multi-RAT URLLC and eMBB Dynamic Task Offloading With MEC Resource Allocation Using Distributed Deep Reinforcement Learning
