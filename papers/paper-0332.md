...
# paper-0332 — A new multi-agent group-buying auction for automated VM-to-Customer mapping
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0332.pdf`)_
