...
pages: 120--136
keywords:
- Collaborative service caching
- Edge computing
- Multi-agent multi-armed bandit model
...
# paper-0430 — Reinforcement learning for cost-effective IoT service caching at the edge
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0430.pdf`)_
