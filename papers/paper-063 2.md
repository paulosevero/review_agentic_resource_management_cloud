...
pages: "2511--2518"
keywords: ["Cloud computing", "FIPA ACL", "Hadoop", "Multi-agent", "Pattern matching", "Query processing", "Sentinel"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-063 — Intelligent query processing from biotechnological database using co-operating agents in a secure cloud environment
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Intelligent query processing from biotechnological database using co-operating agents in a secure cloud environment
