...
# paper-0608 — RTHop: Real-Time Hop-by-Hop Mobile Network Routing by Decentralized Learning With Semantic Attention
...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Multi-access Edge Computing an" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0608.pdf`)_
