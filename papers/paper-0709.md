...
# paper-0709 — Multi-Agent RL for SDN-Based Resource Allocation in HAPS-Assisted IoV Networks
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0709.pdf`)_
