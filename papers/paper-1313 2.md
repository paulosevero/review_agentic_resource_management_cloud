...
authors: ["Yin, Shan", "Liu, Lihao", "Cai, Mengru", "Chai, Yutong", "Jiao, Yurong", "Duan, Zheng", "Li, Yian", "Huang, Shanguo"]
year: 2024
...
pages: "852--867"
keywords: ["5G mobile communication systems", "Blocking probability", "Cooperative communication", "Deep neural networks", "Fiber optic networks", "Mobile edge computing", "Multi agent systems", "Optical communication", "Resource allocation", "Communication overheads", "Communication resources", "Distributed inference", "Metro Optical Network", "Multi agent", "Network inference", "Performance", "Reinforcement learnings", "Resource allocation problem", "Single-agent", "Reinforcement learning"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Yin, Shan and Liu, Lihao and Cai, Mengru and Chai, Yutong and Jiao, Yurong and Duan, Zheng and Li, Yian and Huang, Shanguo
- **Year:** 2024
- **Venue:** Journal of Optical Communications and Networking
- **DOI:** 10.1364/JOCN.533206
- **URL:** https://www.scopus.com/pages/publications/85201072448?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** DNN distributed inference offloading scheme based on transfer reinforcement learning in metro optical networks
