...
# paper-0200 — A Multi-Agent Approach for Vehicle-to-Fog Fair Computation Offloading
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0200.pdf`)_
