...
# paper-0856 — Edge-Cloud Collaborative Motion Planning for Autonomous Driving with Large Language Models
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0856.pdf`)_
