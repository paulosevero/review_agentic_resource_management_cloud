...
pages: "17503--17512"
keywords: ["Access latency", "deep Q-network (DQN)", "load balancing", "mobile-edge computing (MEC)", "server placement"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-385 — Multiobjective Edge Server Placement in Mobile-Edge Computing Using a Combination of Multiagent Deep Q-Network and Coral Reefs Optimization
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Multiobjective Edge Server Placement in Mobile-Edge Computing Using a Combination of Multiagent Deep Q-Network and Coral Reefs Optimization
