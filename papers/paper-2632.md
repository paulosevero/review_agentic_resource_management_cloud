...
pages: "5701--5720"
keywords: ["AWS Lambda", "Job scheduling", "Multi-agent deep Q-Learning", "Performance", "Serverless computing"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** MADQL: Multi-Agent Deep Q-Learning for Optimized Job Scheduling in Serverless Computing
