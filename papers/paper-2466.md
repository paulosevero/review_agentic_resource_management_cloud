...
pages: ''
keywords:
- Additional Key Words and PhrasesEdge computing
- large language models
- LLM applications
- on-device inference
- resource-efficient optimizations
language: English
source:
  databases:
  - Scopus
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2466.pdf`)_
