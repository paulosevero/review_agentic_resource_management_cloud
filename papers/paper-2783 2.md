...
authors: ["Suarez, Jorge Abraham Rios", "Jia, Min", "Shibwabo, Anyembe"]
year: 2026
...
publisher: "Springer"
pages: ""
keywords: ["Fairness Aware Scheduling", "Federated Learning", "Multi Access Edge Computing (MEC)", "Multi Agent Reinforcement Learning (MARL)", "Multipath TCP (MPTCP)", "Permutation Invariance", "Proximal Policy Optimization (PPO)", "Satellite Networks", "Set Transformer"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Suarez, Jorge Abraham Rios and Jia, Min and Shibwabo, Anyembe
- **Year:** 2026
- **Venue:** Telecommunication Systems
- **DOI:** 10.1007/s11235-026-01408-0
- **URL:** https://www.scopus.com/pages/publications/105029055789?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Multi agent federated reinforcement learning for Distributed MPTCP Agents
