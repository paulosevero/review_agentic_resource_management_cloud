...
publisher: "Springer"
pages: "2800--2828"
keywords: ["Cloud computing", "Genetic algorithm", "Load balancing", "Reinforcement learning", "Resource management", "Task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-264 — Task scheduling, resource provisioning, and load balancing on scientific workflows using parallel SARSA reinforcement learning agents and genetic algorithm
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Task scheduling, resource provisioning, and load balancing on scientific workflows using parallel SARSA reinforcement learning agents and genetic algorithm
