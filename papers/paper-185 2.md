...
authors: ["Chen, Jienan", "Wei, Zhongxiang", "Li, Shuai", "Cao, Bin"]
year: 2020
...
pages: "36--43"
keywords: ["Deep learning", "Long short-term memory", "Multi agent systems", "Multimedia services", "Quality of service", "Radio", "Radio access networks", "Reinforcement learning", "Resource allocation", "Video streaming", "Accurate prediction", "Adaptive video streaming", "Computing capacity", "Conventional optimization", "Cross layer optimization", "Multi-user scenario", "Network environments", "Radio resource allocation", "Fog computing"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-185 — Artificial Intelligence Aided Joint Bit Rate Selection and Radio Resource Allocation for Adaptive Video Streaming over F-RANs

## Metadata

- **Authors:** Chen, Jienan and Wei, Zhongxiang and Li, Shuai and Cao, Bin
- **Year:** 2020
- **Venue:** IEEE Wireless Communications
- **DOI:** 10.1109/MWC.001.1900351
- **URL:** https://www.scopus.com/pages/publications/85084793879?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Artificial Intelligence Aided Joint Bit Rate Selection and Radio Resource Allocation for Adaptive Video Streaming over F-RANs
