...
authors: ["Wu, Guowen", "Xu, Zhiqi", "Zhang, Hong", "Shen, Shigen", "Yu, Shui"]
year: 2023
...
pages: "80--94"
keywords: ["Industrial Internet of things", "Mobile edge computing", "Multi-agent deep reinforcement learning", "Queuing theory", "Task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-756 — Multi-agent DRL for joint completion delay and energy consumption with queuing theory in MEC-based IIoT

## Metadata

- **Authors:** Wu, Guowen and Xu, Zhiqi and Zhang, Hong and Shen, Shigen and Yu, Shui
- **Year:** 2023
- **Venue:** Journal of Parallel and Distributed Computing
- **DOI:** 10.1016/j.jpdc.2023.02.008
- **URL:** https://www.scopus.com/pages/publications/85149278228?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Multi-agent DRL for joint completion delay and energy consumption with queuing theory in MEC-based IIoT
