...
pages: "3425--3443"
keywords: ["attention mechanism", "Large-scale computation offloading", "multi-access edge computing", "multi-agent reinforcement learning (MARL)", "recurrent multi-agent actor-critic"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-592 — Large-Scale Computation Offloading Using a Multi-Agent Reinforcement Learning in Heterogeneous Multi-Access Edge Computing
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Large-Scale Computation Offloading Using a Multi-Agent Reinforcement Learning in Heterogeneous Multi-Access Edge Computing
