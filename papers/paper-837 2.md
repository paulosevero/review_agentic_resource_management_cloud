...
pages: "1401--1406"
keywords: ["Cloud Infrastructure Management", "DevOps", "Large language models (LLMs)", "Predictive Analytics", "Resource Allocation"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-837 — Optimizing Cloud Infrastructure Management Using Large Language Models: A DevOps Perspective
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Optimizing Cloud Infrastructure Management Using Large Language Models: A DevOps Perspective
