...
pages: "167--180"
keywords: ["asynchronous system operation", "Mobile edge computing", "multi-agent reinforcement learning", "resource allocation", "task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Asynchronous Task Scheduling and Resource Allocation for UAV-Enabled Mobile Edge Computing Networks
