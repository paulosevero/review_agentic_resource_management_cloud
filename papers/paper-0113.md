...
# paper-0113 — Distributed scheduling in Kubernetes based on MAS for Fog-in-the-loop applications
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0113.pdf`)_
