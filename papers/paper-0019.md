...
pages: 6--23
keywords:
- Cloud data storage and processing security
- Document key print
...
# paper-0019 — A modified cloud-based cryptographic agent for cloud data integrity
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0019.pdf`)_
