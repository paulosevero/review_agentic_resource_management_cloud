...
# paper-0490 — Study and Evaluation of a hybrid architecture to optimize resources in the 5G core network
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0490.pdf`)_
