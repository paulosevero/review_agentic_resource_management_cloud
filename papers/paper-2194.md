...
screening:
  ...
  05-abstract-screening:
    ...
    my_justification: Otimização de performance/custo de federated fine-tuning de LLMs — LLM como workload, não como agente de RM.
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2194.pdf`)_
