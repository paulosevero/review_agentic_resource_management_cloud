...
authors: ["Wang, Zilin", "Chen, Liming", "Chen, Pengxian", "Zheng, Yifeng", "Zhang, Wenjie"]
year: 2026
...
pages: ""
keywords: ["Dynamic trajectory", "Mobile edge computing (MEC)", "Multi-Agent deep deterministic policy gradient (MADDPG)", "Resource allocation", "Service caching", "Unmanned aerial vehicle(UAV)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Wang, Zilin and Chen, Liming and Chen, Pengxian and Zheng, Yifeng and Zhang, Wenjie
- **Year:** 2026
- **Venue:** Computer Networks
- **DOI:** 10.1016/j.comnet.2026.112267
- **URL:** https://www.scopus.com/pages/publications/105034471085?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Joint caching-trajectory optimization for dynamic UAV-MEC networks: Context-aware game combined MADDPG
