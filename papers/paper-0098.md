...
- Green Computing
- Multi-Agent System
- Resource Allocation Smart Data Center
- Virtual Machines
language: English
source:
  databases:
...
# paper-0098 — Smart configuration and auto allocation of resource in cloud data centers
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0098.pdf`)_
