...
pages: "199--202"
keywords: ["actuators", "agents", "distributed architecture", "edge computing", "sensor networks", "streaming data", "swarms"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-550 — Agent-based Orchestration on a Swarm of Edge Devices
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Agent-based Orchestration on a Swarm of Edge Devices
