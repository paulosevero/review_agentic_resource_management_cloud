...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Mobile edge computing (MEC) ha" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1637.pdf`)_
