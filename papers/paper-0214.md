...
# paper-0214 — Agent-Based control of service scheduling within the fog environment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0214.pdf`)_
