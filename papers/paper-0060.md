...
# paper-0060 — Optimal regulation of energy delivery for community microgrids based on constraint satisfaction and multi-agent system
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0060.pdf`)_
