...
# paper-0678 — A Service Consolidation Approach for Edge-Vehicle Network using Multi-agent Decision-making Method
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0678.pdf`)_
