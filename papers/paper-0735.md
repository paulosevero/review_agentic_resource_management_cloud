...
- Joint communication and computing resource allocation (JCCRA)
...
# paper-0735 — Multi-Agent Reinforcement Learning for Distributed Resource Allocation in Cell-Free Massive MIMO-Enabled Mobile Edge Computing Network
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0735.pdf`)_
