...
authors: ["Wei, Erlong", "Wen, Yihong", "Liu, Xuebo"]
year: 2025
...
pages: ""
keywords: ["cloud-edge collaboration", "low earth orbit satellite network", "mobile edge computing", "multiagent deep reinforcement learning", "resources allocation", "task off-loading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Wei, Erlong and Wen, Yihong and Liu, Xuebo
- **Year:** 2025
- **Venue:** IET Signal Processing
- **DOI:** 10.1049/sil2/9674618
- **URL:** https://www.scopus.com/pages/publications/105015567858?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** A Deep Reinforcement Learning–Based Low Earth Orbit Satellite-Enhanced Mobile Edge Computing Framework for Efficient Task Off-Loading
