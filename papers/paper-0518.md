...
# paper-0518 — Cost optimization of UAV-MEC network calculation offloading: A multi-agent reinforcement learning method
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0518.pdf`)_
