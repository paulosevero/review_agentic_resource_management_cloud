...
authors: ["Li, Chuang", "Ji, Jianqiao", "Hu, Zhigang", "Zhou, Zhou"]
year: 2024
...
pages: "2567--2577"
keywords: ["edge computing", "load balancing", "reinforcement learning", "server deployment", "vehicle networking"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Chuang and Ji, Jianqiao and Hu, Zhigang and Zhou, Zhou
- **Year:** 2024
- **Venue:** Zhongnan Daxue Xuebao (Ziran Kexue Ban)/Journal of Central South University (Science and Technology)
- **DOI:** 10.11817/j.issn.1672-7207.2024.07.011
- **URL:** https://www.scopus.com/pages/publications/85200632329?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Edge server deployment strategy based on multi-agent reinforcement learning in the internet of vehicles; [车联网中基于多智能体强化学习的边缘服务器选址策略]
