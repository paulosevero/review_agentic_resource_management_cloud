...
authors: ["Wang, Lei", "Zhou, Wenjiang", "Xu, Haitao", "Li, Liang", "Cai, Lei", "Zhou, Xianwei"]
year: 2023
...
pages: ""
keywords: ["cooperative game", "deep reinforcement learning", "multi-access edge computing", "proximate policy optimization", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-750 — Research on task offloading optimization strategies for vehicular networks based on game theory and deep reinforcement learning

## Metadata

- **Authors:** Wang, Lei and Zhou, Wenjiang and Xu, Haitao and Li, Liang and Cai, Lei and Zhou, Xianwei
- **Year:** 2023
- **Venue:** Frontiers in Physics
- **DOI:** 10.3389/fphy.2023.1292702
- **URL:** https://www.scopus.com/pages/publications/85175365139?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Research on task offloading optimization strategies for vehicular networks based on game theory and deep reinforcement learning
