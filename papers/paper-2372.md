...
keywords:
- MAPPO
- prediction-based task planning
- Satellite-HAP-terrestrial integrated network
- task offloading
language: English
source:
  databases:
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2372.pdf`)_
