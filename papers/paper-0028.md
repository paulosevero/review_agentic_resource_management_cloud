...
# paper-0028 — Distributed resource allocation in cloud computing using multi-agent systems
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0028.pdf`)_
