...
# paper-0097 — Allocation strategy for cloud datacenter based on multi agent and CP approach
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0097.pdf`)_
