...
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Real-time multi-view sports st" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2451.pdf`)_
