...
authors: ["Asim Ejaz, Muhammad", "Wu, Guowei", "Iqbal, Tahir"]
year: 2024
...
pages: ""
keywords: ["maximize profit", "mobile edge computing", "multi-agent algorithm", "network slicing", "online resource allocation", "secure admission control"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-825 — Dynamic and efficient resource allocation for 5G end-to-end network slicing: A multi-agent deep reinforcement learning approach

## Metadata

- **Authors:** Asim Ejaz, Muhammad and Wu, Guowei and Iqbal, Tahir
- **Year:** 2024
- **Venue:** International Journal of Communication Systems
- **DOI:** 10.1002/dac.5916
- **URL:** https://www.scopus.com/pages/publications/85200025703?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Dynamic and efficient resource allocation for 5G end-to-end network slicing: A multi-agent deep reinforcement learning approach
