...
# paper-0515 — Towards Energy Efficient Resource Allocation: When Green Mobile Edge Computing Meets Multi-Agent Deep Reinforcement Learning
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0515.pdf`)_
