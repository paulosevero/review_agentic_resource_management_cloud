...
pages: ""
keywords: ["Cloud computing", "Energy consumption", "Prospective task scheduling", "Reinforcement learning", "Response time", "Task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** An effective method for prospective scheduling of tasks in cloud-fog computing with an energy consumption management approach based on Q-learning
