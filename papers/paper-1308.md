...
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "The Large Language Model (LLM)" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1308.pdf`)_
