...
authors: ["Du, Xiaozheng", "Hu, Shijing", "Zhou, Feng", "Wang, Cheng", "Nguyen, Binh Minh"]
year: 2025
...
pages: ""
keywords: ["LLM", "NL2SQL", "pre-training", "prompt", "Python"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Du, Xiaozheng and Hu, Shijing and Zhou, Feng and Wang, Cheng and Nguyen, Binh Minh
- **Year:** 2025
- **Venue:** Future Internet
- **DOI:** 10.3390/fi17010012
- **URL:** https://www.scopus.com/pages/publications/85215960038?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** FI-NL2PY2SQL: Financial Industry NL2SQL Innovation Model Based on Python and Large Language Model
