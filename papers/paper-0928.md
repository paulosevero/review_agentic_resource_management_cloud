...
pages: ''
keywords:
- bottom-up resource orchestration
- edge computing
...
# paper-0928 — Bottom-Up Resource Orchestration in Edge Computing: An Agent-Based Modeling Approach
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0928.pdf`)_
