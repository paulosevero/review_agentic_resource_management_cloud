...
# paper-0832 — A distributed optimization approach via symmetric group actions under time-varying communication networks
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0832.pdf`)_
