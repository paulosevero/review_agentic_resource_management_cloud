...
# paper-0768 — Learning-Based Sustainable Multi-User Computation Offloading for Mobile Edge-Quantum Computing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0768.pdf`)_
