...
authors: ["Chen, Geng", "Xia, Conghui", "Kong, Lingzhi", "Zeng, Qingtian"]
year: 2026
...
pages: "137--155"
keywords: ["clustering mechanism", "edge offloading", "multi-agent learning", "trajectory optimization"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Chen, Geng and Xia, Conghui and Kong, Lingzhi and Zeng, Qingtian
- **Year:** 2026
- **Venue:** Tongxin Xuebao/Journal on Communications
- **DOI:** 10.11959/j.issn.1000-436x.2026058
- **URL:** https://www.scopus.com/pages/publications/105035012557?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** MADDPG-based edge offloading algorithm assisted by vehicle clustering and UAV trajectory optimization; [车辆聚类及UAV轨迹优化辅助下基于MADDPG的边缘卸载算法]
