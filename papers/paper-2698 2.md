...
authors: ["Luo, Zhongqiang", "Wu, Wenjie", "Dai, Xiang", "Han, Qiang"]
year: 2026
...
pages: ""
keywords: ["Computation offloading", "Dual connectivity technology", "Multi-access edge computing", "Resource allocation", "UAV-assisted MEC", "User-centric network"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Luo, Zhongqiang and Wu, Wenjie and Dai, Xiang and Han, Qiang
- **Year:** 2026
- **Venue:** Physical Communication
- **DOI:** 10.1016/j.phycom.2026.102992
- **URL:** https://www.scopus.com/pages/publications/105027628841?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Deep reinforcement learning-based computation offloading and resource allocation in user-centered UAV-MEC
