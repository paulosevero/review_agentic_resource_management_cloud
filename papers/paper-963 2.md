...
pages: "604--615"
keywords: ["cloud computing", "Deep reinforcement learning", "green computing", "workflow scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-963 — Multi-Agent Deep Reinforcement Learning Framework for Renewable Energy-Aware Workflow Scheduling on Distributed Cloud Data Centers
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Multi-Agent Deep Reinforcement Learning Framework for Renewable Energy-Aware Workflow Scheduling on Distributed Cloud Data Centers
