...
publisher: "SPIE"
pages: ""
keywords: ["3D parallelism", "Cloud computing", "Large model", "NLP", "Optimization"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** An efficient parallel optimization method for large model based on cloud computing
