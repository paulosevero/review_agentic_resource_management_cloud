...
# paper-0600 — Multi-Agent Interests Service Composition Optimization in Cloud Manufacturing Environment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0600.pdf`)_
