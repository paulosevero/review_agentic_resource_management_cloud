...
authors: ["Mao, Weichao", "Qiu, Haoran", "Wang, Chen", "Franke, Hubertus", "Kalbarczyk, Zbigniew", "Iyer, Ravishankar K.", "Ba\u015far, Tamer"]
year: 2022
...
pages: ""
keywords: ["Approximation algorithms", "Fertilizers", "Learning algorithms", "Multi agent systems", "Natural resources management", "Resource allocation", "Cloud services", "Functions approximations", "Game approach", "Mean-field games", "Multi tenancies", "Multi-agent reinforcement learning", "Real-world", "Reinforcement learnings", "Resource management", "Shared resources", "Reinforcement learning"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-473 — A Mean-Field Game Approach to Cloud Resource Management with Function Approximation

## Metadata

- **Authors:** Mao, Weichao and Qiu, Haoran and Wang, Chen and Franke, Hubertus and Kalbarczyk, Zbigniew and Iyer, Ravishankar K. and Başar, Tamer
- **Year:** 2022
- **Venue:** Advances in Neural Information Processing Systems
- **DOI:** N/A
- **URL:** https://www.scopus.com/pages/publications/85143253754?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** A Mean-Field Game Approach to Cloud Resource Management with Function Approximation
