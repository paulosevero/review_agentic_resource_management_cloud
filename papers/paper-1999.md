...
authors: ["Niu, Huiying", "Lv, Ke", "Shi, Fei", "Cai, Jinglun", "Huang, Sai"]
year: 2025
...
pages: "2295--2299"
keywords: ["Deep reinforcement learning", "Large language model", "Mobile edge computing", "Unmanned aerial vehicle"]
language: "English"
source:
  databases: ["Scopus"]
...
screening:
  "04-title-screening":
    ...
    human_justification: "Talvez tenha algo de LLM e/ou Agentic AI (mesmo tendo DRL)."
...
- **Authors:** Niu, Huiying and Lv, Ke and Shi, Fei and Cai, Jinglun and Huang, Sai
- **Year:** 2025
- **Venue:** Proceedings of the IEEE International Conference on Computer and Communications, ICCC
- **DOI:** 10.1109/ICCC68654.2025.11437715
- **URL:** https://www.scopus.com/pages/publications/105035767623?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** LLM-Guided DRL for Optimizing Energy Efficiency in Multi-Cluster MEC Networks
