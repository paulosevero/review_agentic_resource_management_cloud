...
authors: ["Feng, Hao", "Huang, Gan", "Zhou, Nian", "Zhang, Feng", "Liu, Yuming", "Zhou, Xiumin", "Liu, Junchen"]
year: 2025
...
pages: ""
keywords: ["collaborative inference", "Large Language Models (LLMs)", "Mobile Edge Intelligence (MEI)", "model partitioning", "user mobility"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Feng, Hao and Huang, Gan and Zhou, Nian and Zhang, Feng and Liu, Yuming and Zhou, Xiumin and Liu, Junchen
- **Year:** 2025
- **Venue:** Electronics (Switzerland)
- **DOI:** 10.3390/electronics14193929
- **URL:** https://www.scopus.com/pages/publications/105019044202?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** DAPO: Mobility-Aware Joint Optimization of Model Partitioning and Task Offloading for Edge LLM Inference
