...
# paper-0144 — A multi-agent system approach for service deployment in the cloud
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0144.pdf`)_
