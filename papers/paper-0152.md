...
# paper-0152 — Multiagent system for dynamic resource provisioning in cloud computing platforms
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0152.pdf`)_
