...
authors: ["Gu, Huixian", "Zhao, Liqiang", "Han, Zhu", "Zheng, Gan", "Song, Shenghui"]
year: 2024
...
pages: "1322--1385"
keywords: ["applications", "Cloud-edge-terminal collaborative network (CETCN)", "collaborative caching", "mobility management", "multiagent reinforcement learning (MARL)", "network architecture", "resource allocation", "security", "single-agent reinforcement learning (SARL)", "standards", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-937 — AI-Enhanced Cloud-Edge-Terminal Collaborative Network: Survey, Applications, and Future Directions

## Metadata

- **Authors:** Gu, Huixian and Zhao, Liqiang and Han, Zhu and Zheng, Gan and Song, Shenghui
- **Year:** 2024
- **Venue:** IEEE Communications Surveys and Tutorials
- **DOI:** 10.1109/COMST.2023.3338153
- **URL:** https://www.scopus.com/pages/publications/85184489215?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** AI-Enhanced Cloud-Edge-Terminal Collaborative Network: Survey, Applications, and Future Directions
