---
id: paper-0088
title: Elastic and load-spike proof one-to-many negotiation to improve the service acceptability of an open SaaS provider; [Négociation multi-agents résistante aux pics de charge pour améliorer l’acceptabilité
  des services d’un fournisseur SaaS ouvert]
authors:
- Najjar, Amro
- Picard, Gauthier
- Boissier, Olivier
...
# paper-0088 — Elastic and load-spike proof one-to-many negotiation to improve the service acceptability of an open SaaS provider; [Négociation multi-agents résistante aux pics de charge pour améliorer l’acceptabilité des services d’un fournisseur SaaS ouvert]
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0088.pdf`)_
