...
authors: ["Wang, Ji", "Zhang, Miao", "Yin, Quanjun", "Yin, Lujia", "Peng, Yong"]
year: 2025
...
pages: ""
keywords: ["Hybrid action space", "Multi-access edge computing", "Multiagent proximal policy optimization (MAPPO)", "Reward design", "Task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Wang, Ji and Zhang, Miao and Yin, Quanjun and Yin, Lujia and Peng, Yong
- **Year:** 2025
- **Venue:** Ad Hoc Networks
- **DOI:** 10.1016/j.adhoc.2024.103671
- **URL:** https://www.scopus.com/pages/publications/85204939127?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Multi-agent reinforcement learning for task offloading with hybrid decision space in multi-access edge computing
