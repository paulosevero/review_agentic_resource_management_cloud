...
# paper-0532 — Trust-Based Multi-Agent Imitation Learning for Green Edge Computing in Smart Cities
...
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Green communications and netwo" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0532.pdf`)_
