...
# paper-0291 — An Automata-based Profit Optimization of Cloud Brokers in IaaS Environment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0291.pdf`)_
