...
# paper-0130 — Dynamic task offloading in multi-agent mobile edge computing networks
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0130.pdf`)_
