...
pages: "478--483"
keywords: ["Agent-Based Simulation", "Algorithmic Fairness", "Behavioral Fairness", "Envy-Freeness", "Fairness Constraints", "Multi-Objective Optimization", "Personalized Pricing", "Price Discrimination"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** Fairness-Aware Personalized Pricing: A Simulation Study of Trade-offs Across Behavioral, Group, and Envy-Based Constraints
