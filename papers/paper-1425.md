...
- **evidence_trail:**
  ...
  - `{ category: classical_agents, pattern_id: ovr_cls_llm_present, matched_substring: "Prompt Engineering" }`
  - `{ category: llm_agentic_ai_generic, pattern_id: gen_prompt_engineering, matched_substring: "Prompt Engineering" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1425.pdf`)_
