...
# paper-0117 — A Hierarchical distributed energy management agent framework for smart homes, grids, and cities
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0117.pdf`)_
