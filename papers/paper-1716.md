...
authors: ["Ju, Tao", "Zhang, Yufei", "Ma, Yaling", "Huo, Jiuyuan"]
year: 2025
...
pages: "79--90"
keywords: ["deep reinforcement learning", "internet of vehicles\uff08IoV)", "mobile edge computing", "software defined network", "task offloading"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
- **Authors:** Ju, Tao and Zhang, Yufei and Ma, Yaling and Huo, Jiuyuan
- **Year:** 2025
- **Venue:** Hunan Daxue Xuebao/Journal of Hunan University Natural Sciences
- **DOI:** 10.16339/j.cnki.hdxbzkb.2025268
- **URL:** https://www.scopus.com/pages/publications/105004038511?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** A Multi-layer Distributed Edge Computing Task Dynamic Offloading Strategy in Internet of Vehicles; [多 层 分 布 式 车 联 网 边 缘 计 算 任 务 动 态 卸 载 策 略]
