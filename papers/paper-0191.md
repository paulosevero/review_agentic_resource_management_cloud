...
# paper-0191 — Resource Management for Power-Constrained HEVC Transcoding Using Reinforcement Learning
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0191.pdf`)_
