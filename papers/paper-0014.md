...
# paper-0014 — Towards a fairer negotiation for dynamic resource allocation in cloud by relying on trustworthiness
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0014.pdf`)_
