...
# paper-0906 — Decentralized Vehicular Edge Computing Framework for Energy-Efficient Task Coordination
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0906.pdf`)_
