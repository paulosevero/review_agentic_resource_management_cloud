...
# paper-0415 — Multi-Agent Driven Resource Allocation and Interference Management for Deep Edge Networks
...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Sixth generation mobile networ" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0415.pdf`)_
