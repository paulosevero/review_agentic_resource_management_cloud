...
authors: ["Jyoti, Amrita", "Shrimali, Manish"]
year: 2020
...
publisher: "Springer"
pages: "377--395"
keywords: ["Cloud computing", "Dynamic optimal load-aware service broker", "Dynamic resource allocation", "Mixed Integer Programming", "Multi-agent deep reinforcement learning", "Service Measurement Index"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-212 — Dynamic provisioning of resources based on load balancing and service broker policy in cloud computing

## Metadata

- **Authors:** Jyoti, Amrita and Shrimali, Manish
- **Year:** 2020
- **Venue:** Cluster Computing
- **DOI:** 10.1007/s10586-019-02928-y
- **URL:** https://www.scopus.com/pages/publications/85064347105?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Dynamic provisioning of resources based on load balancing and service broker policy in cloud computing
