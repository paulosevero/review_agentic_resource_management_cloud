...
# paper-0656 — Energy Efficient Computation Offloading in Aerial Edge Networks With Multi-Agent Cooperation
...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "With the high flexibility of s" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0656.pdf`)_
