---
id: "paper-1307"
title: "Renewable energy management in smart grid with cloud security analysis using multi agent machine learning model"
authors: ["Yang, Zhuang"]
year: 2024
venue: "Computers and Electrical Engineering"
venue_type: "other"
doi: "10.1016/j.compeleceng.2024.109177"
url: "https://www.scopus.com/pages/publications/85188660864?origin=resultslist"
publisher: "Elsevier Ltd"
pages: ""
keywords: ["Cloud network", "Machine learning", "Multi agent Markov reinforcement learning", "Security analysis", "Smart grid"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-1307 — Renewable energy management in smart grid with cloud security analysis using multi agent machine learning model
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Renewable energy management in smart grid with cloud security analysis using multi agent machine learning model
