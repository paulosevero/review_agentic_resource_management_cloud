...
authors: ["Xue, Jianbin", "Mao, Peipei", "Wang, Luyao", "Yu, Qingda", "Fan, Changwang"]
year: 2025
...
pages: "243--267"
keywords: ["air-ground integrated network (AGIN)", "dynamic task offloading", "multi-agent deep deterministic policy gradient (MADDPG)", "non-orthogonal multiple access (NOMA)", "resource allocation"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Xue, Jianbin and Mao, Peipei and Wang, Luyao and Yu, Qingda and Fan, Changwang
- **Year:** 2025
- **Venue:** Journal of Beijing Institute of Technology (English Edition)
- **DOI:** 10.15918/j.jbit1004-0579.2024.124
- **URL:** https://www.scopus.com/pages/publications/105012397904?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Dynamic Task Offloading and Resource Allocation for Air-Ground Integrated Networks Based on MADDPG
