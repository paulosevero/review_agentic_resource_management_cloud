...
authors: ["Mutlag, Ammar Awad", "Ghani, Mohd Khanapi Abd", "Mohammed, Mazin Abed", "Lakhan, Abdullah", "Mohd, Othman", "Abdulkareem, Karrar Hameed", "Garcia-Zapirain, Begonya"]
year: 2021
venue: "Sensors"
venue_type: "journal"
...
publisher: "MDPI"
pages: ""
keywords: ["Balancing", "Cardiology", "Cloud computing", "Fog computing", "Multi-agent system", "Prioritization", "Scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-320 — Multi-agent systems in fog–cloud computing for critical healthcare task management model (CHTM) used for ECG monitoring

## Metadata

- **Authors:** Mutlag, Ammar Awad and Ghani, Mohd Khanapi Abd and Mohammed, Mazin Abed and Lakhan, Abdullah and Mohd, Othman and Abdulkareem, Karrar Hameed and Garcia-Zapirain, Begonya
- **Year:** 2021
- **Venue:** Sensors
- **DOI:** 10.3390/s21206923
- **URL:** https://www.scopus.com/pages/publications/85117196177?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Multi-agent systems in fog–cloud computing for critical healthcare task management model (CHTM) used for ECG monitoring
