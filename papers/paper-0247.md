...
# paper-0247 — An edge based multi-agent auto communication method for traffic light control
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0247.pdf`)_
