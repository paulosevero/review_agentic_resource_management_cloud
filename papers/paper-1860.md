...
authors: ["Lin, Tuxiang", "Lin, Rongliang"]
year: 2025
venue: "IEEE Access"
venue_type: "journal"
...
pages: "15062--15078"
keywords: ["intelligent transportation systems", "Long short-term memory (LSTM)", "proximal policy optimization (PPO)", "spatio-temporal graph convolutional networks (STGCN)", "traffic flow prediction"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Lin, Tuxiang and Lin, Rongliang
- **Year:** 2025
- **Venue:** IEEE Access
- **DOI:** 10.1109/ACCESS.2024.3519512
- **URL:** https://www.scopus.com/pages/publications/85212627245?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Smart City Traffic Flow and Signal Optimization Using STGCN-LSTM and PPO Algorithms
