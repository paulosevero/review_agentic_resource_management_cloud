...
# paper-0112 — Osmotic computing as a distributed multi-agent system: The Body Area Network scenario
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0112.pdf`)_
