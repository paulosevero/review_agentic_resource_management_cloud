...
# paper-0022 — Load balancing, cost and response time minimisation issues in agent-based multi cloud service composition
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0022.pdf`)_
