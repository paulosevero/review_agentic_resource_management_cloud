...
# paper-0148 — Fog agents in distributed multi agent system for autonomous energy management
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0148.pdf`)_
