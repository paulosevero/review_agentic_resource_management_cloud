...
# paper-0100 — Replicated Computations Results (RCR) report for “A holistic approach for collaborative workload execution in volunteer clouds”
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0100.pdf`)_
