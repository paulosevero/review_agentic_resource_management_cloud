...
- **evidence_trail:**
  ...
  - `{ category: classical_agents, pattern_id: cls_agent_term, matched_substring: "agent" }`
  - `{ category: llm_agentic_ai_generic, pattern_id: gen_ai_ran, matched_substring: "AI-RAN" }`
  - `{ category: llm_agentic_ai_generic, pattern_id: gen_ai_ran, matched_substring: "AI-RAN" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2256.pdf`)_
