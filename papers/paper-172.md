...
authors: ["Abbas, Ghulam", "Mehmood, Amjad", "Lloret, Jaime", "Raza, Muhammad Summair", "Ibrahim, Muhammad"]
year: 2020
...
pages: ""
keywords: ["cloud computing", "cloud discovery and selection", "cloud ontology", "FIPA", "JADE", "multiagent system"]
language: "English"
source:
  databases: ["Scopus"]
...
screening:
  "04-title-screening":
    ...
    human_justification: "MAS clássico pré-LLM (FIPA)"

---

# paper-172 — FIPA-based reference architecture for efficient discovery and selection of appropriate cloud service using cloud ontology

## Metadata

- **Authors:** Abbas, Ghulam and Mehmood, Amjad and Lloret, Jaime and Raza, Muhammad Summair and Ibrahim, Muhammad
- **Year:** 2020
- **Venue:** International Journal of Communication Systems
- **DOI:** 10.1002/dac.4504
- **URL:** https://www.scopus.com/pages/publications/85087758265?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** FIPA-based reference architecture for efficient discovery and selection of appropriate cloud service using cloud ontology
