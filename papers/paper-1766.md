...
screening:
  ...
  05-abstract-screening:
    ...
    my_justification: LLM para automação de políticas de segurança em runtime cloud-native — segurança, não RM (Boundary B).
    agrees_with_regex: false
    divergence_reason: null
    locked_at_iteration: iter-0
    locked_at: '2026-05-09T00:00:00+00:00'
...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "LLM" }`
  - `{ category: llm_as_workload, pattern_id: wl_inference_llm_a, matched_substring: "LLM-Driven Automation of Runti" }`
  - `{ category: llm_as_workload, pattern_id: wl_inference_llm_a, matched_substring: "LLM-based synthesis and applie" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1766.pdf`)_
