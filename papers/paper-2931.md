...
authors: ["Zhao, Yang", "Luo, Hanjiang", "Tao, Hang", "Wang, Jingjing", "Zhou, Jiehan", "Wu, Kaishun"]
year: 2026
...
pages: "8561--8577"
keywords: ["Deep reinforcement learning", "Internet of Things (IoT)", "large language model (LLM)", "maritime data collection", "uncrewed aerial vehicles (UAVs)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zhao, Yang and Luo, Hanjiang and Tao, Hang and Wang, Jingjing and Zhou, Jiehan and Wu, Kaishun
- **Year:** 2026
- **Venue:** IEEE Internet of Things Journal
- **DOI:** 10.1109/JIOT.2025.3642563
- **URL:** https://www.scopus.com/pages/publications/105024826883?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** MECOS: Cooperative Multi-UAV-Assisted Cross-Boundary Maritime Data Collection Leveraging MARL and LLM
