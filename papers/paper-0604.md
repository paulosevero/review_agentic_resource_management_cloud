...
# paper-0604 — Asynchronous Federated Learning-Based Resource Management in URLLC-IoV Networks
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0604.pdf`)_
