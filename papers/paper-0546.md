...
# paper-0546 — An AI Factory Digital Twin Deployed Within a High Performance Edge Architecture
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0546.pdf`)_
