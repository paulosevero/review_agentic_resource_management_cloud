...
# paper-0078 — Optimizing collaborative computations for scalable distributed inference in large graphs
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0078.pdf`)_
