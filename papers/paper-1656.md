...
screening:
  ...
  05-abstract-screening:
    ...
    my_justification: LLM para análise de ameaças de cibersegurança — domínio de segurança, não gerenciamento de recursos (Boundary B).
    agrees_with_regex: false
    divergence_reason: null
    locked_at_iteration: iter-0
    locked_at: '2026-05-09T00:00:00+00:00'
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1656.pdf`)_
