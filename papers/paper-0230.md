...
# paper-0230 — GMTA: A Geo-Aware Multi-Agent Task Allocation Approach for Scientific Workflows in Container-Based Cloud
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0230.pdf`)_
