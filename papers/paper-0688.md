...
# paper-0688 — Multi-Agent Task Assignment in Vehicular Edge Computing: A Regret-Matching Learning-Based Approach
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0688.pdf`)_
