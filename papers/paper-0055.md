...
# paper-0055 — A secure and dependable multi-Agent autonomous intersection management (MA-AIM) system leveraging blockchain facilities
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0055.pdf`)_
