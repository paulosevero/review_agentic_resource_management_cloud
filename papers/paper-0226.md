...
# paper-0226 — MAFC: Multi-agent fog computing model for healthcare critical tasks management
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0226.pdf`)_
