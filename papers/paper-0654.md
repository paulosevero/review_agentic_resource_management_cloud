...
# paper-0654 — Adaptive Processing for Video Streaming with Energy Constraint: A Multi-Agent Reinforcement Learning Method
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0654.pdf`)_
