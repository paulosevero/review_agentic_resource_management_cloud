...
authors: ["Zhang, Jie", "Sun, Kai", "Huang, Wei", "Wu, Jingmiao", "Zhang, Haijun", "Leung, Victor C.M."]
year: 2025
...
pages: ""
keywords: ["game theory", "mobile edge computing (MEC)", "multi-agent multi-armed bandit (MAMAB)", "User association resource allocation (UARA)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zhang, Jie and Sun, Kai and Huang, Wei and Wu, Jingmiao and Zhang, Haijun and Leung, Victor C.M.
- **Year:** 2025
- **Venue:** IEEE Transactions on Vehicular Technology
- **DOI:** 10.1109/TVT.2025.3637866
- **URL:** https://www.scopus.com/pages/publications/105023164837?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Decentralized User Association and Resource Allocation for Mobile Edge Computing Network
