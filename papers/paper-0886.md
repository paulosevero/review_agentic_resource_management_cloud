...
# paper-0886 — A Multiagent Meta-Based Task Offloading Strategy for Mobile-Edge Computing
...
- **overrides_applied:** []
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Task offloading in mobile-edge" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0886.pdf`)_
