...
authors: ["Balla, Husamelddin", "Sheng, Chen", "Weipeng, Jing"]
year: 2021
...
pages: "36--47"
keywords: ["Cloud computing", "Multi-agent scheduler", "Neural fitted Q", "Queuing theory", "Reinforcement learning", "Reliability"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-267 — Reliability-aware: Task scheduling in cloud computing using multi-agent reinforcement learning algorithm and neural fitted q

## Metadata

- **Authors:** Balla, Husamelddin and Sheng, Chen and Weipeng, Jing
- **Year:** 2021
- **Venue:** International Arab Journal of Information Technology
- **DOI:** 10.34028/iajit/18/1/5
- **URL:** https://www.scopus.com/pages/publications/85098751900?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Reliability-aware: Task scheduling in cloud computing using multi-agent reinforcement learning algorithm and neural fitted q
