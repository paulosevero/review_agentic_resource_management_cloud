...
- **overrides_applied:** []
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "To solve the problems of high" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2331.pdf`)_
