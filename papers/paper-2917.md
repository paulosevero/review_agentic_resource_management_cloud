...
authors: ["Zhang, Ke", "Wang, Xu", "Jiang, Chuanwen", "Dong, Yahan", "Shahidehpour, Mohammad", "Wang, Chongyu"]
year: 2026
...
pages: ""
keywords: ["bidding strategy", "cluster algorithm", "data center", "power flexibility", "reinforcement learning"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zhang, Ke and Wang, Xu and Jiang, Chuanwen and Dong, Yahan and Shahidehpour, Mohammad and Wang, Chongyu
- **Year:** 2026
- **Venue:** IEEE Transactions on Industry Applications
- **DOI:** 10.1109/TIA.2026.3654487
- **URL:** https://www.scopus.com/pages/publications/105028041541?origin=resultslist
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** Physical System-Constrained Transactive Bidding Strategy for Data Centers with Workload Flexibility in Electricity Markets
