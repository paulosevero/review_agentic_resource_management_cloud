...
pages: ""
keywords: ["application placement", "fog computing", "quantile temporal difference learning", "small language model"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Small Language Model-Guided Quantile Temporal Difference Learning for Improved IoT Application Placement in Fog Computing
