...
# paper-0672 — Towards Energy-efficient Resource Allocation for Federated Learning in Mobile Edge Computing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0672.pdf`)_
