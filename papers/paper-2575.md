...
authors: ["Gan, Deqiao", "Xu, Xiaoxia", "Ge, Xiaohu", "Liu, Yuanwei"]
year: 2026
...
pages: "10002--10017"
keywords: ["Artificial intelligence generated content (AIGC)", "large language model (LLM)", "mobile edge generation (MEG)", "non-orthogonal multiple access (NOMA)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Gan, Deqiao and Xu, Xiaoxia and Ge, Xiaohu and Liu, Yuanwei
- **Year:** 2026
- **Venue:** IEEE Transactions on Wireless Communications
- **DOI:** 10.1109/TWC.2025.3648836
- **URL:** https://www.scopus.com/pages/publications/105028067030?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** NOMA-Assisted Mobile Edge Generation (MEG): Enabling Mobile Access to Large Models
