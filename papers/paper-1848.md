...
authors: ["Lin, Yuanmo", "Xu, Zhiyong", "Li, Jianhua", "Wang, Jingyuan", "Li, Cheng"]
year: 2025
...
pages: ""
keywords: ["deep reinforcement learning (DRL)", "emergency communication", "mobile edge computing (MEC)", "non-orthogonal multiple access (NOMA)", "unmanned aerial vehicle (UAV)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Lin, Yuanmo and Xu, Zhiyong and Li, Jianhua and Wang, Jingyuan and Li, Cheng
- **Year:** 2025
- **Venue:** IET Communications
- **DOI:** 10.1049/cmu2.70063
- **URL:** https://www.scopus.com/pages/publications/105013960955?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Deep Reinforcement Learning-Based Intelligent Resource Management in Multi-UAVs-Assisted MEC Emergency Communication System
