...
pages: "144--154"
keywords: ["Deep Reinforcement", "dynamic resource allocation", "Learning(DRL)", "Mobile Edge Computing(MEC)", "multiple Unmanned Aerial Vehicle (UAV)", "wireless power transfer"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Method of Joint Optimization for Multi-UAV Energy Transfer and Edge Computing Based on Deep Reinforcement Learning
