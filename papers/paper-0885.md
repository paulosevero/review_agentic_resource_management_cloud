...
# paper-0885 — Optimizing Resource Allocation and Request Routing for AI-Generated Content (AIGC) Services in Mobile Edge Networks With Cell Coupling
...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "AIGC" }`
  - `{ category: llm_as_workload, pattern_id: wl_inference_llm_b, matched_substring: "deployment and service of pre-" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0885.pdf`)_
