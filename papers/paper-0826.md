...
# paper-0826 — Optimizing Resource Allocation in Mobile Edge Computing for IIoT through Reinforcement Learning and Multiobjective Particle Swarm Optimization
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0826.pdf`)_
