...
authors: ["Moghaddasi, Komeil", "Jurdak, Raja"]
year: 2026
...
pages: ""
keywords: ["Deep reinforcement learning", "Energy-Efficient Application", "Federated Learning", "Mobile edge computing", "Vehicular networks"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Moghaddasi, Komeil and Jurdak, Raja
- **Year:** 2026
- **Venue:** Ad Hoc Networks
- **DOI:** 10.1016/j.adhoc.2025.104043
- **URL:** https://www.scopus.com/pages/publications/105019251037?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** An energy-aware distributed federated soft actor-critic framework for intelligent task offloading in vehicular mobile edge computing networks
