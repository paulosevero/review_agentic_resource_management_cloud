...
# paper-0255 — A fairness-enhanced resource trading system in federated cloud environments
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0255.pdf`)_
