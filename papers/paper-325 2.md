...
authors: ["Oudaa, Toutou", "Gharsellaoui, Hamza", "Ben Ahmed, Samir"]
year: 2021
...
pages: "3795--3804"
keywords: ["Deep reinforcement learning", "Quantile regresion-DQN", "Resource provisioning", "Task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-325 — An agent-based model for resource provisioning and task scheduling in cloud computing using DRL

## Metadata

- **Authors:** Oudaa, Toutou and Gharsellaoui, Hamza and Ben Ahmed, Samir
- **Year:** 2021
- **Venue:** Procedia Computer Science
- **DOI:** 10.1016/j.procs.2021.09.154
- **URL:** https://www.scopus.com/pages/publications/85116914247?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** An agent-based model for resource provisioning and task scheduling in cloud computing using DRL
