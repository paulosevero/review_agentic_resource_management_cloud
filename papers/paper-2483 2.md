...
pages: "285--298"
keywords: ["AIGC", "autonomous driving", "large language models", "mobile edge network"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** EdgeDriver: optimising autonomous driving assistance with multi-LLM framework in cloud-edge computing environments
