...
authors: ["Zhang, Manjun", "Wang, Ying", "Yu, Peng", "Qiu, Xuesong", "Guo, Shaoyong"]
year: 2026
...
pages: ""
keywords: ["Eco-efficient computing", "Edge-cloud continuum", "GAT", "Green energy utilization", "MAPPO", "MLLM Task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zhang, Manjun and Wang, Ying and Yu, Peng and Qiu, Xuesong and Guo, Shaoyong
- **Year:** 2026
- **Venue:** Computer Networks
- **DOI:** 10.1016/j.comnet.2026.112257
- **URL:** https://www.scopus.com/pages/publications/105034384222?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Eco-efficient task scheduling for MLLMs in edge-cloud continuum
