...
authors: ["Dai, Penglin", "Liu, Kai", "Wu, Xiao", "Xing, Huanlai", "Yu, Zhaofei", "Lee, Victor C. S."]
year: 2019
...
pages: ""
keywords: ["Edge computing", "Information services", "Multi agent systems", "Network architecture", "Optimal systems", "Real time systems", "Reinforcement learning", "Vehicles", "Cloud based computing", "Heterogeneous computing", "Multi-agent reinforcement learning", "Optimal solutions", "Real time service", "Vehicular mobilities", "Vehicular networks", "Wireless coverage", "Learning algorithms"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-121 — A Learning Algorithm for Real-Time Service in Vehicular Networks with Mobile-Edge Computing

## Metadata

- **Authors:** Dai, Penglin and Liu, Kai and Wu, Xiao and Xing, Huanlai and Yu, Zhaofei and Lee, Victor C. S.
- **Year:** 2019
- **Venue:** IEEE International Conference on Communications
- **DOI:** 10.1109/ICC.2019.8761190
- **URL:** https://www.scopus.com/pages/publications/85070194788?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** A Learning Algorithm for Real-Time Service in Vehicular Networks with Mobile-Edge Computing
