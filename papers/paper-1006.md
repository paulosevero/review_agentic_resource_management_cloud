...
authors: ["Li, Yang", "Wei, Ziling", "Su, Jinshu", "Zhao, Baokang"]
year: 2024
...
pages: "824--838"
keywords: ["Multi-access edge computing", "Multi-agent reinforcement learning", "Task scheduling", "TP301.6", "Unmanned aerial vehicles"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Yang and Wei, Ziling and Su, Jinshu and Zhao, Baokang
- **Year:** 2024
- **Venue:** Frontiers of Information Technology and Electronic Engineering
- **DOI:** 10.1631/FITEE.2300393
- **URL:** https://www.scopus.com/pages/publications/85197524934?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** A multi-agent collaboration scheme for energy-efficient task scheduling in a 3D UAV-MEC space; [三维无人机-多接入边缘计算场景下的多智能体协作任务调度能效优化方案]
