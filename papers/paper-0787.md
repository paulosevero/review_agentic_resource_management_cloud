...
# paper-0787 — A Stochastic Games based Resource Allocation Method for Cloud based Safe Computing Platform
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0787.pdf`)_
