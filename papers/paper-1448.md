...
authors: ["Carrascal, David", "D\u00edaz-Fuentes, Javier", "Manso, Nicolas", "Lopez-Pajares, Diego", "Rojas, Elisa", "Savi, Marco", "Arco, Jose M."]
year: 2025
...
pages: ""
keywords: ["AI-driven orchestration", "cloud/edge continuum", "distributed intelligence", "Industrial Internet of Things (IIoT)", "softwarized edge computing"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Carrascal, David and Díaz-Fuentes, Javier and Manso, Nicolas and Lopez-Pajares, Diego and Rojas, Elisa and Savi, Marco and Arco, Jose M.
- **Year:** 2025
- **Venue:** Applied Sciences (Switzerland)
- **DOI:** 10.3390/app151910829
- **URL:** https://www.scopus.com/pages/publications/105031710917?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Softwarized Edge Intelligence for Advanced IIoT Ecosystems: A Data-Driven Architecture Across the Cloud/Edge Continuum
