...
# paper-0208 — Artificial intelligent agent for energy savings in cloud computing environment: Implementation and performance evaluation
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0208.pdf`)_
