...
# paper-0030 — Intelligent strategy of allocation resource for cloud datacenter based on MAS & CP approach
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0030.pdf`)_
