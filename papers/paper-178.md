...
pages: ""
keywords: ["Cloud computing", "Cooperative agents", "Dependent tasks", "Markov game", "Reinforcement learning", "Resource management"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-178 — A cloud resource management framework for multiple online scientific workflows using cooperative reinforcement learning agents
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** A cloud resource management framework for multiple online scientific workflows using cooperative reinforcement learning agents
