...
authors: ["Nagabushnam, Ganesan", "Kim, Kyong Hoon", "Choi, Yundo"]
year: 2025
...
publisher: "Springer"
pages: ""
keywords: ["Aperiodic task", "Cloud computing", "Deadline task", "Deep multi-agent reinforcement learning", "Heterogeneous Fog computing", "IoT", "Proximal policy optimization", "Recurrent neural network", "Task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Nagabushnam, Ganesan and Kim, Kyong Hoon and Choi, Yundo
- **Year:** 2025
- **Venue:** Cluster Computing
- **DOI:** 10.1007/s10586-025-05588-3
- **URL:** https://www.scopus.com/pages/publications/105013677031?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** FAMASO: fog-adaptive multi-agent scheduling optimization
