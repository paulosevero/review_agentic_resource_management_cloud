...
authors: ["Xiao, Da", "Zhang, J. Andrew", "Liu, Xin", "Qu, Yiwen", "Ni, Wei", "Liu, Ren Ping"]
year: 2023
...
pages: "4297--4312"
keywords: ["graph convolutional network", "multi-agent", "multi-datacenter", "Network function virtualization"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-758 — A Two-Stage GCN-Based Deep Reinforcement Learning Framework for SFC Embedding in Multi-Datacenter Networks

## Metadata

- **Authors:** Xiao, Da and Zhang, J. Andrew and Liu, Xin and Qu, Yiwen and Ni, Wei and Liu, Ren Ping
- **Year:** 2023
- **Venue:** IEEE Transactions on Network and Service Management
- **DOI:** 10.1109/TNSM.2023.3284293
- **URL:** https://www.scopus.com/pages/publications/85162655394?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** A Two-Stage GCN-Based Deep Reinforcement Learning Framework for SFC Embedding in Multi-Datacenter Networks
