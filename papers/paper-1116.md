...
authors: ["Panesar, Gurpreet Singh", "Chadha, Raman"]
year: 2024
...
pages: "30--45"
keywords: ["Adaptive Multi-Agent System (AMS)", "Deep Deterministic Policy Gradient (DDPG)", "Iterative Concept of War and Rat Swarm (ICWRS)", "Rat Swarm Optimizer (RSO)", "System Optimization", "War Strategy Optimization (WSO)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Panesar, Gurpreet Singh and Chadha, Raman
- **Year:** 2024
- **Venue:** International Journal of Intelligent Systems and Applications in Engineering
- **DOI:** N/A
- **URL:** https://www.scopus.com/pages/publications/85181524637?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** A Hybrid Optimization Algorithm for Efficient Virtual Machine Migration and Task Scheduling Using a Cloud-Based Adaptive Multi-Agent Deep Deterministic Policy Gradient Technique
