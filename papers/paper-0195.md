...
# paper-0195 — A cooperative agents-based workflow-level distributed data placement strategy for scientific cloud workflows
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0195.pdf`)_
