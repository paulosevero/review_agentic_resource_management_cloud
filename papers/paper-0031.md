...
# paper-0031 — Co-optimization of communication, sensing, and computation for information gathering using cloud computing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0031.pdf`)_
