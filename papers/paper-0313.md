...
# paper-0313 — Performance and energy-aware bi-objective tasks scheduling for cloud data centers
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0313.pdf`)_
