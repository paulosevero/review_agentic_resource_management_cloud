...
# paper-0610 — Cross-Regional Task Offloading with Multi-Agent Reinforcement Learning for Hierarchical Vehicular Fog Computing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0610.pdf`)_
