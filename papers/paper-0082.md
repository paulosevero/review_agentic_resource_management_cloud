...
# paper-0082 — Formal approach to validated allocation process based on MAS and CP system
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0082.pdf`)_
