...
# paper-0646 — Joint optimization method of intelligent service arrangement and computing-networking resource allocation for MEC; [移动边缘计算中智能服务编排和算网资源分配联合优化方法]
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0646.pdf`)_
