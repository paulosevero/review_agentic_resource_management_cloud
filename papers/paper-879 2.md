...
publisher: "Springer"
pages: "409--457"
keywords: ["Energy consumption", "Fog computing", "Multi-objective optimization", "Service response time", "SPEAII", "Task scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-879 — Delay-Aware and Energy-Efficient Task Scheduling Using Strength Pareto Evolutionary Algorithm II in Fog-Cloud Computing Paradigm
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Delay-Aware and Energy-Efficient Task Scheduling Using Strength Pareto Evolutionary Algorithm II in Fog-Cloud Computing Paradigm
