...
authors: ["Hu, Yaqi", "Ye, Dongdong", "Kang, Jiawen", "Wu, Maoqiang", "Yu, Rong"]
year: 2025
...
pages: "13208--13221"
keywords: ["Advanced driver assistance systems (ADASs)", "DDPG", "diffusion model", "edge computing", "Internet of Things (IoT) networks", "multimodal large language models (MLLMs)", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Hu, Yaqi and Ye, Dongdong and Kang, Jiawen and Wu, Maoqiang and Yu, Rong
- **Year:** 2025
- **Venue:** IEEE Internet of Things Journal
- **DOI:** 10.1109/JIOT.2024.3509628
- **URL:** https://www.scopus.com/pages/publications/85211225296?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** A Cloud–Edge Collaborative Architecture for Multimodal LLM-Based Advanced Driver Assistance Systems in IoT Networks
