...
pages: ""
keywords: ["edge computing", "prioritized offloading", "reinforcement learning", "vehicular networks"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Counterfactual Multi-Agent DRL for Efficient Task Offloading in Vehicular Edge Computing
