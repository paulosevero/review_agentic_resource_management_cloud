...
# paper-0236 — A Hierarchical Fog-based Architecture for IoT-enabled Intelligent Traffic Lights System Services
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0236.pdf`)_
