...
authors: ["Kasi, Mumraiz Khan", "Ghazalah, Sarah Abu", "Akram, Raja Naeem", "Sauveron, Damien"]
year: 2021
...
publisher: "MDPI"
pages: ""
keywords: ["Edge security", "Mobile edge computing", "Mobile edge server placement", "Multiagent RL"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-300 — Secure mobile edge server placement using multi-agent reinforcement learning

## Metadata

- **Authors:** Kasi, Mumraiz Khan and Ghazalah, Sarah Abu and Akram, Raja Naeem and Sauveron, Damien
- **Year:** 2021
- **Venue:** Electronics (Switzerland)
- **DOI:** 10.3390/electronics10172098
- **URL:** https://www.scopus.com/pages/publications/85114426805?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Secure mobile edge server placement using multi-agent reinforcement learning
