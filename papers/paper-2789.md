...
authors: ["Sun, Yukun", "Yu, Wenhan", "Zhou, Xinyu", "Zhao, Jun", "Zhang, Xing"]
year: 2026
...
pages: "11619--11635"
keywords: ["Computing offloading", "device-enhanced mobile edge computing (MEC)", "distributed task scheduling", "game theory", "multiagent deep reinforcement learning (DRL)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Sun, Yukun and Yu, Wenhan and Zhou, Xinyu and Zhao, Jun and Zhang, Xing
- **Year:** 2026
- **Venue:** IEEE Internet of Things Journal
- **DOI:** 10.1109/JIOT.2025.3646683
- **URL:** https://www.scopus.com/pages/publications/105026480951?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Multiagent Deep Reinforcement Learning for Device-Enhanced Distributed Task Scheduling in Terminal-Edge Collaborative Computing Networks
