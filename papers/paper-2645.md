...
authors: ["Kumar, Tarun", "Tripathy, Aalap", "Saranathan, Gayathri", "Foltin, Martin", "Bhattacharya, Suparna", "Hinchley, Scott", "Bahls, Donald M.", "Brookshire, David", "Kaplan, Larry", "Wisniewski, Robert W."]
year: 2026
...
pages: "40295--40301"
keywords: ["Critical infrastructures", "Cybersecurity", "Decision making", "Formal logic", "Formal verification", "Hierarchical systems", "High level languages", "Middleware", "Network security", "Context-Aware", "Contextual reasoning", "Cyber security", "Infrastructure managements", "Model contexts", "Multi-layered", "Multi-layers", "Natural language policy", "Secure modeling", "Security vulnerabilities", "Agents"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Kumar, Tarun and Tripathy, Aalap and Saranathan, Gayathri and Foltin, Martin and Bhattacharya, Suparna and Hinchley, Scott and Bahls, Donald M. and Brookshire, David and Kaplan, Larry and Wisniewski, Robert W.
- **Year:** 2026
- **Venue:** Proceedings of the AAAI Conference on Artificial Intelligence
- **DOI:** 10.1609/aaai.v40i47.41468
- **URL:** https://www.scopus.com/pages/publications/105034265138?origin=resultslist
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** InfrastructureSentinel: Policy Enforced Guardrails for Secure MCP-driven Infrastructure Agents
