...
pages: ""
keywords: ["fog computing", "large language model", "Q learning", "resource provisioning", "scalability"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Scalable Resource Provisioning Framework for Fog Computing Using LLM-Guided Q-Learning Approach
