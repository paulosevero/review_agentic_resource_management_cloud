...
- Unreewed aerial vehicle (UAV)-assisted multi-access edge computing (MEC)
- user association and trajectory control
language: English
source:
  databases:
  - Scopus
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2577.pdf`)_
