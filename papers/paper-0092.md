...
# paper-0092 — An agent-based network resource management concept for smart city services
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0092.pdf`)_
