...
- **evidence_trail:**
  ...
  - `{ category: rl, pattern_id: rl_madrl, matched_substring: "MADRL" }`
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "In vehicular networks" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2433.pdf`)_
