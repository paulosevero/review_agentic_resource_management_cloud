...
pages: ""
keywords: ["Admission control policy (ACP)", "Cloud computing", "Cross-cloud data migration", "Key agreement", "Multi-agent reinforcement learning algorithm (MARL)"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-693 — Admission control policy and key agreement based on anonymous identity in cloud computing

## Metadata

- **Authors:** Paulraj, D. and Neelakandan, S. and Prakash, M. and Baburaj, E.
- **Year:** 2023
- **Venue:** Journal of Cloud Computing
- **DOI:** 10.1186/s13677-023-00446-2
- **URL:** https://www.scopus.com/pages/publications/85158132627?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Admission control policy and key agreement based on anonymous identity in cloud computing
