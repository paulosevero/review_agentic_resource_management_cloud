...
authors: ["Li, Chunlin", "Zhang, Yong", "Yu, Long", "Jiang, Kun", "Luo, Youlong", "Wan, Shaohua"]
year: 2024
...
pages: ""
keywords: ["cooperative content caching", "I-MADDPG", "UAV-assisted VEC", "user preference predic- tions"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Chunlin and Zhang, Yong and Yu, Long and Jiang, Kun and Luo, Youlong and Wan, Shaohua
- **Year:** 2024
- **Venue:** ACM Transactions on Sensor Networks
- **DOI:** 10.1145/3701234
- **URL:** https://www.scopus.com/pages/publications/85210126852?origin=resultslist
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** DRL-based Content Caching Strategy With Efficient User Preference Predictions in UAV-assisted VEC
