...
# paper-0207 — Multi-agent task allocation based on the learning of managers and local preference selections
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0207.pdf`)_
