...
# paper-0364 — Integrated route planning and resource allocation for connected vehicles
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0364.pdf`)_
