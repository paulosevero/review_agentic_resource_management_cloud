...
authors: ["Khan, Israr", "Raza, Salman", "Khan, Razaullah", "Rehman, Waheed ur", "Rahman, G. M. Shafiqur", "Tao, Xiaofeng"]
year: 2023
...
pages: ""
keywords: ["advanced asynchronous advantage actor-critic (A3C)", "cloud computing", "computational offloading", "deep reinforcement learning", "energy efficiency", "mobile edge computing", "multi-agent system"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-629 — Distributed Multi-Agent Approach for Achieving Energy Efficiency and Computational Offloading in MECNs Using Asynchronous Advantage Actor-Critic

## Metadata

- **Authors:** Khan, Israr and Raza, Salman and Khan, Razaullah and Rehman, Waheed ur and Rahman, G. M. Shafiqur and Tao, Xiaofeng
- **Year:** 2023
- **Venue:** Electronics (Switzerland)
- **DOI:** 10.3390/electronics12224605
- **URL:** https://www.scopus.com/pages/publications/85178336723?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Distributed Multi-Agent Approach for Achieving Energy Efficiency and Computational Offloading in MECNs Using Asynchronous Advantage Actor-Critic
