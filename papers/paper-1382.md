...
authors: ["Ali, Endris Mohammed", "Lemma, Frezewd", "Srinivasagan, Ramasamy", "Abawajy, Jemal"]
year: 2025
...
pages: ""
keywords: ["deep reinforcement learning (DRL)", "fog computing", "Internet of Things (IoT)", "multi-agent", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Ali, Endris Mohammed and Lemma, Frezewd and Srinivasagan, Ramasamy and Abawajy, Jemal
- **Year:** 2025
- **Venue:** Electronics (Switzerland)
- **DOI:** 10.3390/electronics14112169
- **URL:** https://www.scopus.com/pages/publications/105008496125?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Efficient Delay-Sensitive Task Offloading to Fog Computing with Multi-Agent Twin Delayed Deep Deterministic Policy Gradient
