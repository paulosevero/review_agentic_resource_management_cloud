...
# paper-0845 — Crux: GPU-Efficient Communication Scheduling for Deep Learning Training
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0845.pdf`)_
