...
authors: ["Ullah, Amin", "Ul Haq, Qazi Mazhar", "Ali, Sajid"]
year: 2026
...
pages: ""
keywords: ["Double Dueling Deep Q-Network (D3QN)", "Internet of Things (IoT)", "Long Short-Term Memory (LSTM)", "Mobile Edge Computing (MEC)", "unmanned aerial vehicles (UAVs)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Ullah, Amin and Ul Haq, Qazi Mazhar and Ali, Sajid
- **Year:** 2026
- **Venue:** Proceedings - IEEE Consumer Communications and Networking Conference, CCNC
- **DOI:** 10.1109/CCNC65079.2026.11366608
- **URL:** https://www.scopus.com/pages/publications/105034206000?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Energy-Efficient Path Planning and Task Scheduling for UAV-Assisted Wireless Networks via Double Dueling Deep Q-Networks with LSTM
