...
# paper-0775 — A battlefield task distribution strategy optimization model based on edge computing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0775.pdf`)_
