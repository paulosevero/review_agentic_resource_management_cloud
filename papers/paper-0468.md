...
screening:
  04-title-screening:
    ...
    my_justification: '"Rational-based" talvez indique o uso de agents'
...
# paper-0468 — Learn to Coordinate for Computation Offloading and Resource Allocation in Edge Computing: A Rational-Based Distributed Approach
...
- **overrides_applied:** []
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "In response to the growing dem" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0468.pdf`)_
