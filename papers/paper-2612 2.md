...
authors: ["Hu, Qiaojun", "Wang, Wei", "Huang, Chongzhu", "Wang, Xiaoyu", "Li, Yajie", "Zhao, Yongli", "Zheng, Yanlei", "Tan, Yanxia", "Zhang, Jie"]
year: 2026
...
pages: "137--149"
keywords: ["Adaptive optics", "Computational efficiency", "Fiber optic networks", "Light transmission", "Optical communication", "Program processors", "'current", "Data-transmission", "Datacenter", "Feasible solution", "Interleavings", "Language model", "Model size", "Model training", "Optical-", "Over provisioning", "Bandwidth"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Hu, Qiaojun and Wang, Wei and Huang, Chongzhu and Wang, Xiaoyu and Li, Yajie and Zhao, Yongli and Zheng, Yanlei and Tan, Yanxia and Zhang, Jie
- **Year:** 2026
- **Venue:** Journal of Optical Communications and Networking
- **DOI:** 10.1364/JOCN.579324
- **URL:** https://www.scopus.com/pages/publications/105029741678?origin=resultslist
...
- **Final Score:** 0.8333
- **Decision:** include
- **Evidence Excerpt:** Task placement and traffic interleaving for cross-datacenter LLM training over optical networks
