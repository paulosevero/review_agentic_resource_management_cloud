...
# paper-0070 — Controlled intelligent agents' security model for multi-tenant cloud computing infrastructures
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0070.pdf`)_
