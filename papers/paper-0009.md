...
# paper-0009 — A network aware approach for the scheduling of virtual machine migration during peak loads
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0009.pdf`)_
