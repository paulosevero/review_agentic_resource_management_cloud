...
# paper-0990 — Reliability and performance of resource efficiency in dynamic optimization scheduling using multi-agent microservice cloud-fog on IoT applications
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0990.pdf`)_
