...
pages: ""
keywords: ["Internet of things", "Mobile edge computing", "Neural networks", "Reinforcement learning", "Resource allocation"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Optimizing lightweight neural networks for efficient mobile edge computing
