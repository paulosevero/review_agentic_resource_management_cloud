...
# paper-0414 — Edge Intelligence-based Obstacle Intrusion Detection in Railway Transportation
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0414.pdf`)_
