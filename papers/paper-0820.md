...
# paper-0820 — Multi-Agent Reinforcement Learning for Distributed Workflow Orchestration at the Tactical Edge
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0820.pdf`)_
