...
authors: ["Chen, Dong", "Zhang, Ximing", "Lin, Kequan", "Mei, Chunhua", "Huo, Ru"]
year: 2026
venue: "Algorithms"
venue_type: "journal"
...
pages: ""
keywords: ["mobile edge computing", "mobility modeling", "multi-agent deep reinforcement learning (MADRL)", "resource allocation", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Chen, Dong and Zhang, Ximing and Lin, Kequan and Mei, Chunhua and Huo, Ru
- **Year:** 2026
- **Venue:** Algorithms
- **DOI:** 10.3390/a19030221
- **URL:** https://www.scopus.com/pages/publications/105034257151?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Mobility-Aware Cooperative Optimization for Task Offloading and Resource Allocation in Multi-Edge Computing
