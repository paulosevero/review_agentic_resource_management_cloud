...
pages: ""
keywords: ["Clustering", "Routing protocol", "Squirrel search algorithm", "Wireless Sensor Networks"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Enhancing wireless sensor network lifespan and efficiency through improved cluster head selection using improved squirrel search algorithm
