...
authors: ["Hu, Fangxiang", "Fu, Qi", "Zhang, Shiwen", "Huang, Jing"]
year: 2026
...
pages: ""
keywords: ["6G", "cloud-edge-device collaboration", "high-density vehicle", "multi-agent proximal policy optimization", "resource allocation", "task offloading", "Vehicular edge computing"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Hu, Fangxiang and Fu, Qi and Zhang, Shiwen and Huang, Jing
- **Year:** 2026
- **Venue:** Computers, Materials and Continua
- **DOI:** 10.32604/cmc.2026.074154
- **URL:** https://www.scopus.com/pages/publications/105035886134?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** A Multi-Agent Deep Reinforcement Learning-Based Task Offloading Method for 6G-Enabled Internet of Vehicles with Cloud-Edge-Device Collaboration
