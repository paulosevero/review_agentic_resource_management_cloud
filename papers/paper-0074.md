...
- Dynamic clouds federation
- Multi agent resource allocation
- Multi agent system
- Multi-criterions self-adaptation
...
# paper-0074 — AMACE: agent based multi-criterions adaptation in cloud environment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0074.pdf`)_
