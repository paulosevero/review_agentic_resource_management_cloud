...
pages: ""
keywords: ["Cloud computing", "deep reinforcement learning", "multi-access edge computing", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Cooperative Task Offloading for Multi-Access Edge-Cloud Networks: A Multi-Group Multi-Agent Deep Reinforcement Learning
