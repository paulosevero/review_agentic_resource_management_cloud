...
# paper-0057 — Bag-of-tasks intelligent scheduling agent (BISA) in cloud computing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0057.pdf`)_
