...
authors: ["Li, Xuanheng", "Du, Xinyang", "Zhao, Nan", "Wang, Xianbin"]
year: 2024
...
pages: "1355--1369"
keywords: ["computation offloading", "mobile edge computing", "reinforcement learning", "trajectory control", "Unmanned aerial vehicle"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Xuanheng and Du, Xinyang and Zhao, Nan and Wang, Xianbin
- **Year:** 2024
- **Venue:** IEEE Transactions on Communications
- **DOI:** 10.1109/TCOMM.2023.3331029
- **URL:** https://www.scopus.com/pages/publications/85177063155?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Computing over the Sky: Joint UAV Trajectory and Task Offloading Scheme Based on Optimization-Embedding Multi-Agent Deep Reinforcement Learning
