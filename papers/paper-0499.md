...
# paper-0499 — VERA: Resource Orchestration for Virtualized Services at the Edge
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0499.pdf`)_
