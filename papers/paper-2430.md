...
authors: ["Zhang, Chao", "Wang, Junxuan", "Zhang, Yanyan", "Chen, Jiale"]
year: 2025
...
publisher: "SPIE"
pages: ""
keywords: ["MEC", "Multi-Agent Deep Reinforcement Learning (MADRL)", "RIS", "UAV"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zhang, Chao and Wang, Junxuan and Zhang, Yanyan and Chen, Jiale
- **Year:** 2025
- **Venue:** Proceedings of SPIE - The International Society for Optical Engineering
- **DOI:** 10.1117/12.3093872
- **URL:** https://www.scopus.com/pages/publications/105026838433?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Energy and Fairness Optimization in RIS-Assisted Multi-UAV AMEC Based on Multi-Agent Reinforcement Learning
