...
authors: ["Sun, Minghao", "Hou, Jinbo", "Qiu, Kehai", "Wang, Kezhi", "Chu, Xiaoli", "Zhang, Zitian"]
year: 2026
...
pages: "5262--5267"
keywords: ["Internet of Things", "large language model", "resource allocation", "Satellite mobile edge computing", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Sun, Minghao and Hou, Jinbo and Qiu, Kehai and Wang, Kezhi and Chu, Xiaoli and Zhang, Zitian
- **Year:** 2026
- **Venue:** IEEE Transactions on Vehicular Technology
- **DOI:** 10.1109/TVT.2025.3612207
- **URL:** https://www.scopus.com/pages/publications/105017044680?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** LLM-Based Task Offloading and Resource Allocation in Satellite Edge Computing Networks
