...
- Satellite–terrestrial edge computing
...
- **overrides_applied:** []
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "The integration of satellite I" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2029.pdf`)_
