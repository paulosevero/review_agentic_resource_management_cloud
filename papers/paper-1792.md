...
authors: ["Li, Hui", "Zhu, Zhilong", "Li, Yingying", "Huang, Wanwei", "Wang, Zhiheng"]
year: 2025
...
pages: ""
keywords: ["distributed multi-agent deep q-network", "edge computing", "low-Earth-orbit satellite network", "resource allocation", "task offloading"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Hui and Zhu, Zhilong and Li, Yingying and Huang, Wanwei and Wang, Zhiheng
- **Year:** 2025
- **Venue:** Electronics (Switzerland)
- **DOI:** 10.3390/electronics14204063
- **URL:** https://www.scopus.com/pages/publications/105020238025?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Edge Computing Task Offloading Algorithm Based on Distributed Multi-Agent Deep Reinforcement Learning
