...
publisher: "Springer"
pages: "26885--26906"
keywords: ["Cost minimization", "Deep reinforcement learning", "Markov decision process", "Mobile edge computing", "Power allocation"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-627 — Deep Reinforcement Learning-based Power Control and Bandwidth Allocation Policy for Weighted Cost Minimization in Wireless Networks
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Deep Reinforcement Learning-based Power Control and Bandwidth Allocation Policy for Weighted Cost Minimization in Wireless Networks
