...
pages: ""
keywords: ["efficiency", "fault-tolerant communication", "Maritime search and rescue", "multi-agent reinforcement learning", "rescue ship", "unmanned aerial vehicle"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-637 — Maritime Search and Rescue Leveraging Heterogeneous Units: A Multi-Agent Reinforcement Learning Approach
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Maritime Search and Rescue Leveraging Heterogeneous Units: A Multi-Agent Reinforcement Learning Approach
