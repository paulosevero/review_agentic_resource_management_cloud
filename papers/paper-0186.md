...
# paper-0186 — Joint Optimization of Task Offloading and Resource Allocation via Deep Reinforcement Learning for Augmented Reality in Mobile Edge Network
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0186.pdf`)_
