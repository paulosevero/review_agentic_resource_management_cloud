...
# paper-0977 — Demo: An Experimental Platform for AI Model Partitioning on Resource-constrained Devices
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0977.pdf`)_
