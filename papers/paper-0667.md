...
# paper-0667 — Secure Transmission for Multi-UAV-Assisted Mobile Edge Computing Based on Reinforcement Learning
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0667.pdf`)_
