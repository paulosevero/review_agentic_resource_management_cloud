...
pages: "17196--17207"
keywords: ["ant colony optimization", "cloud services composition", "metaheuristic algorithm", "Quality of Service"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-280 — An Effective Multi-Agent Ant Colony Optimization Algorithm for QoS-Aware Cloud Service Composition
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** An Effective Multi-Agent Ant Colony Optimization Algorithm for QoS-Aware Cloud Service Composition
