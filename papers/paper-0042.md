...
# paper-0042 — Multiagent-Based Resource Allocation for Energy Minimization in Cloud Computing Systems
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0042.pdf`)_
