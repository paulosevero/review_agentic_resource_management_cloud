...
- **evidence_trail:**
  ...
  - `{ category: llm_agentic_ai_generic, pattern_id: gen_large_model, matched_substring: "Large Models" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2293.pdf`)_
