...
pages: ""
keywords: ["latency", "Multi-agent deep-reinforcement learning", "Task coordination", "Vehicular edge computing"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-905 — Decentralized Multi-layer Vehicular Edge Computing Framework for Time-Efficient Task Coordination
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Decentralized Multi-layer Vehicular Edge Computing Framework for Time-Efficient Task Coordination
