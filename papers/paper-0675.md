...
# paper-0675 — Multi-agent system-based fuzzy constraints offer negotiation of workflow scheduling in Fog-Cloud environment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0675.pdf`)_
