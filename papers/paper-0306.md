...
# paper-0306 — Video Service-Oriented Vehicular Collaboration: A Multi-Agent Proximal Policy Optimization Approach
...
- **overrides_applied:** []
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "To guarantee heterogeneous per" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0306.pdf`)_
