...
authors: ["Bi, Zhihui", "Yang, Fan", "Li, Zhenyu", "Liu, Guanqi", "Kuang, Zhufang"]
year: 2026
...
pages: ""
keywords: ["Deep Reinforcement Learning", "Mobile edge computing", "Stackelberg Game", "Task Offloading", "Trajectory design"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Bi, Zhihui and Yang, Fan and Li, Zhenyu and Liu, Guanqi and Kuang, Zhufang
- **Year:** 2026
- **Venue:** IEEE Transactions on Mobile Computing
- **DOI:** 10.1109/TMC.2026.3655784
- **URL:** https://www.scopus.com/pages/publications/105028413517?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** SG-MAPG: A Three-Layer Hierarchical Model for Service Fairness and Cost Optimization in UAV-Assisted MEC Systems
