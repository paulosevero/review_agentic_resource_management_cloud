...
# paper-0711 — Computational offloading in vehicular edge computing using multiple agent-based deterministic policy gradient algorithm and generative adversarial networks
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0711.pdf`)_
