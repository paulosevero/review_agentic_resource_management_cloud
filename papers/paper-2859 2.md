...
pages: "2850--2864"
keywords: ["auction theory", "deep reinforcement learning (DRL)", "edge intelligence", "large language model (LLM) agents", "Space-air-ground integrated networks (SAGINs)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Cached Model-as-a-Resource: Provisioning Large Language Model Agents for Edge Intelligence in Space–Air–Ground Integrated Networks
