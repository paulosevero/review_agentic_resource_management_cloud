...
authors: ["Nie, Yiwen", "Zhao, Junhui", "Gao, Feifei", "Yu, F. Richard"]
year: 2021
...
pages: "13162--13173"
keywords: ["Deep reinforcement learning (DRL)", "Federated learning (FL)", "Multi-access edge computing (MEC)", "Resource allocation", "Unmanned aerial vehicle (UAV)"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-322 — Semi-distributed resource management in UAV-aided MEC systems: A multi-agent federated reinforcement learning approach

## Metadata

- **Authors:** Nie, Yiwen and Zhao, Junhui and Gao, Feifei and Yu, F. Richard
- **Year:** 2021
- **Venue:** IEEE Transactions on Vehicular Technology
- **DOI:** 10.1109/TVT.2021.3118446
- **URL:** https://www.scopus.com/pages/publications/85117121951?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Semi-distributed resource management in UAV-aided MEC systems: A multi-agent federated reinforcement learning approach
