...
- **winning_category:** 'mas_llm_based'
- **overrides_applied:** ['ovr_rl_llm_present', 'ovr_intent_driven']
- **evidence_trail:**
  - `{ category: rl, pattern_id: ovr_rl_llm_present, matched_substring: "Intent-Driven" }`
  - `{ category: llm_as_workload, pattern_id: ovr_intent_driven, matched_substring: "Intent-Driven" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1955.pdf`)_
