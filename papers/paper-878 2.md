...
pages: ""
keywords: ["Computation offloading", "Energy harvesting", "Mobile edge computing", "Multi-agent deep reinforcement learning", "Non-orthogonal multiple access", "Resource allocation"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-878 — Decentralized computation offloading via multi-agent deep reinforcement learning for NOMA-assisted mobile edge computing with energy harvesting devices

## Metadata

- **Authors:** Daghayeghi, Atousa and Nickray, Mohsen
- **Year:** 2024
- **Venue:** Journal of Systems Architecture
- **DOI:** 10.1016/j.sysarc.2024.103139
- **URL:** https://www.scopus.com/pages/publications/85190481127?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** Decentralized computation offloading via multi-agent deep reinforcement learning for NOMA-assisted mobile edge computing with energy harvesting devices
