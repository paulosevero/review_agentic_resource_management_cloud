...
authors: ["Yang, Zheng", "Dong, Liang", "Cai, Xinjun"]
year: 2023
...
pages: "46--65"
keywords: ["edge computing", "multi-agent cooperation", "multi-objective optimization", "Pareto optimal state", "real-time video analysis"]
language: "Chinese"
source:
  databases: ["Scopus"]
...
# paper-773 — Toward cooperative multi-agent video streaming perception; [面向多设备协同场景的实时视频流分析系统]

## Metadata

- **Authors:** Yang, Zheng and Dong, Liang and Cai, Xinjun
- **Year:** 2023
- **Venue:** Scientia Sinica Informationis
- **DOI:** 10.1360/SSI-2021-0179
- **URL:** https://www.scopus.com/pages/publications/85147954520?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Toward cooperative multi-agent video streaming perception; [面向多设备协同场景的实时视频流分析系统]
