...
authors: ["Ling, Chengfang", "Peng, Kai", "Wang, Shangguang", "Xu, Xiaolong", "Leung, Victor C. M."]
year: 2024
...
pages: "3037--3051"
keywords: ["attention mechanism", "IIoT", "mobile edge computing", "multi-agent deep reinforcement learning"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Ling, Chengfang and Peng, Kai and Wang, Shangguang and Xu, Xiaolong and Leung, Victor C. M.
- **Year:** 2024
- **Venue:** IEEE Transactions on Services Computing
- **DOI:** 10.1109/TSC.2024.3466852
- **URL:** https://www.scopus.com/pages/publications/85206250782?origin=resultslist
...
- **Final Score:** 1.0
- **Decision:** include
- **Evidence Excerpt:** A Multi-Agent DRL-Based Computation Offloading and Resource Allocation Method With Attention Mechanism in MEC-Enabled IIoT
