...
- `reasoning-by-decision` (anchor: `RQ3.1`) — contributes: `Knowledge Retrieval` × `Placement & Offloading`.
...
- `reasoning-temporal` (anchor: `RQ3.1`) — contributes: `2026` × `Knowledge Retrieval`.
- `temporal-included` (anchor: `RQ1`) — contributes: `2026`.
