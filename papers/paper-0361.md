...
authors:
- Yakubu, Ismail Zaharaddeen
- Muhammed, Lele
- Musa, Zainab Aliyu
- Matinja, Zakari Idris
- Adamu, Ilya Musa
...
# paper-0361 — A multi agent based dynamic resource allocation in fog-cloud computing environment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0361.pdf`)_
