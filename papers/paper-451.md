...
authors: ["Kumar, Savitha", "Chinnasamy, Chandrasekar"]
year: 2022
...
pages: "743--756"
keywords: ["Edge computing", "Gru", "Ml", "Reinforcement learning", "Sdn", "Vanet"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-451 — Route Optimization using Hybrid GRU Learning Model for SDN and Edge-Based VANET Topology

## Metadata

- **Authors:** Kumar, Savitha and Chinnasamy, Chandrasekar
- **Year:** 2022
- **Venue:** Journal of Computer Science
- **DOI:** 10.3844/jcssp.2022.743.756
- **URL:** https://www.scopus.com/pages/publications/85136637598?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Route Optimization using Hybrid GRU Learning Model for SDN and Edge-Based VANET Topology
