...
# paper-0533 — Adaptive Digital Twin and Multiagent Deep Reinforcement Learning for Vehicular Edge Computing and Networks
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0533.pdf`)_
