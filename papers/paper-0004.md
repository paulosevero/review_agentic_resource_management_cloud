...
# paper-0004 — ABS: Agent-Based Scheduling for Data-Intensive Workflow in Software-as-a-Service Environments
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0004.pdf`)_
