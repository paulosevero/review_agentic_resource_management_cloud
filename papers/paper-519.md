...
pages: ""
keywords: ["Computer architecture", "Data handling", "Edge computing", "Electric substations", "Fixed platforms", "Inspection", "Intelligent agents", "Markov processes", "Network architecture", "Edge computing", "Inspection platform", "Inspection software", "Intelligent operations", "Layer data", "Live line measurement", "Measurement device", "Measurements of", "Physical architecture", "Platform design", "Multi agent systems"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-519 — Design of intelligent operation inspection platform based on the multi-agent system for live line measurement of substation

## Metadata

- **Authors:** Xuefeng, Ning and Yao, Guo
- **Year:** 2022
- **Venue:** Journal of Physics: Conference Series
- **DOI:** 10.1088/1742-6596/2401/1/012088
- **URL:** https://www.scopus.com/pages/publications/85145210412?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Design of intelligent operation inspection platform based on the multi-agent system for live line measurement of substation
