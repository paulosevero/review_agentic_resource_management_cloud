...
pages: "487--497"
keywords: ["Application programming interfaces (APIs)", "Cognitive agents (CAs)", "Heterogeneous cloud services (HCSs)", "Internet of Things (IoT)", "Microservices"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-095 — Multi-agent cognitive architecture-enabled IoT applications of mobile edge computing
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Multi-agent cognitive architecture-enabled IoT applications of mobile edge computing
