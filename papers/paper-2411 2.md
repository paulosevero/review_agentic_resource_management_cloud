...
authors: ["Zemtsop Ndadji, Brice Arl\u00e9on", "Bliudze, Simon", "Quinton, Cl\u00e9ment"]
year: 2025
...
pages: "123--147"
keywords: ["adaptive workflows", "autonomic computing", "cloud microservices", "decentralized adaptation", "MAPE-K loop", "self-adaptive systems"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Zemtsop Ndadji, Brice Arléon and Bliudze, Simon and Quinton, Clément
- **Year:** 2025
- **Venue:** Electronic Proceedings in Theoretical Computer Science, EPTCS
- **DOI:** 10.4204/EPTCS.438.7
- **URL:** https://www.scopus.com/pages/publications/105028571355?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** AdaptiFlow: An Extensible Framework for Event-Driven Autonomy in Cloud Microservices
