...
screening:
  ...
  05-abstract-screening:
    ...
    my_justification: Autores mencionam "RL-Based Orchestration. Logo, cai em RL, não em Agentic AI/LLM-based.
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-2422.pdf`)_
