...
# paper-0703 — A Dynamic Adaptive Bio-Inspired Multi-Agent System for Healthcare Task Deployment
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0703.pdf`)_
