---
id: paper-0071
title: 'JaCa-MM: A user-centric BDI multiagent communication framework applied for negotiating and scheduling multi-participant events a jason/cartago extension framework for diary scheduling events permitting
  a hybrid combination of multimodal devices based on a microservices architecture'
authors:
- Herrera, Juan Luis López
- Figueroa, Homero Vladimir Rios
...
# paper-0071 — JaCa-MM: A user-centric BDI multiagent communication framework applied for negotiating and scheduling multi-participant events a jason/cartago extension framework for diary scheduling events permitting a hybrid combination of multimodal devices based on a microservices architecture
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0071.pdf`)_
