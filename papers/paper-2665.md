...
authors: ["Li, Chuangxin", "Li, Jixiao", "Gao, Yongqiang", "Song, Jiawei", "Wang, Zhigang"]
year: 2026
...
pages: ""
keywords: ["Interdependent subtasks", "Mobile edge computing", "Resource allocation", "Task migration", "Workflows scheduling"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Li, Chuangxin and Li, Jixiao and Gao, Yongqiang and Song, Jiawei and Wang, Zhigang
- **Year:** 2026
- **Venue:** Future Generation Computer Systems
- **DOI:** 10.1016/j.future.2025.108091
- **URL:** https://www.scopus.com/pages/publications/105014610298?origin=resultslist
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Multidimensional resource load-aware task migration in mobile edge computing
