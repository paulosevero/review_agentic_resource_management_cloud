...
- data centre heterogeneity
- deep reinforcement learning
- heterogeneous resource regulation
language: English
source:
  databases:
  - Scopus
...
screening:
  04-title-screening:
    ...
    my_justification: A contribuição parece legal. Se foi pego pela search string, talvez tenha algo de agent no abstract ou keywords.
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1866.pdf`)_
