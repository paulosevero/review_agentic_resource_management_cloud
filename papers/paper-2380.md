...
pages: "958--963"
keywords: ["Decision making", "Information services", "Intelligent agents", "Intelligent systems", "Intelligent vehicle highway systems", "Quality of service", "Telecommunication services", "Traffic control", "Vehicles", "Edge computing", "Experience replay", "Intelligent transport", "Migration strategy", "Multi agent", "Policy optimization", "Resource-scheduling", "Service migration", "Traffic safety", "Transport systems", "Efficiency", "Multi agent systems"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.6667
- **Decision:** exclude
- **Evidence Excerpt:** Multi-Agents Service Migration Strategy Under Vehicle Edge Computing
