...
screening:
  04-title-screening:
    ...
    my_justification: Talvez negotiation implique no uso de agentes.
...
# paper-0571 — Efficient Resource Scheduling for Distributed Infrastructures Using Negotiation Capabilities
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0571.pdf`)_
