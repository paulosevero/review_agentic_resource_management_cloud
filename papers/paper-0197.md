...
# paper-0197 — A multi-Agent based model for task scheduling in cloud-fog computing platform
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0197.pdf`)_
