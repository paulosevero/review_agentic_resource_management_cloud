...
# paper-0245 — A Constraint-based approach to edge resource allocation for complex event processing
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0245.pdf`)_
