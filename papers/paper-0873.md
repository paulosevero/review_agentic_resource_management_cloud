...
# paper-0873 — MEC-Intelligent Agent Support for Low-Latency Data Plane in Private NextG Core
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0873.pdf`)_
