...
authors:
- Jakkaraju, Venkata Thej Deep
- Cherukupalle, Naga Subrahmanyam
- Mane, Vijay
...
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "With cloud-native settings bec" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-1689.pdf`)_
