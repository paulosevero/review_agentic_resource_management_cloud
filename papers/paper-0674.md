...
# paper-0674 — Efficient Data as a Service in Fog Computing: An Adaptive Multi-Agent Based Approach
...
- **overrides_applied:** []
- **evidence_trail:**
  - `{ category: rl, pattern_id: rl_ma_rl_combo, matched_substring: "Data as a Service (DaaS) offer" }`
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0674.pdf`)_
