...
# paper-0862 — Joint Task and Computing Resource Allocation in Distributed Edge Computing Systems via Multi-Agent Deep Reinforcement Learning
...
_(populated by `/screen --stage full-text`. PDF location: `raw/pdfs/paper-0862.pdf`)_
