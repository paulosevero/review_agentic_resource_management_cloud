...
pages: "345--348"
keywords: ["AI Security", "Asymmetric Adversarial Attacks", "Black-Box Optimization", "Low-Resource High-Impact Attacks (LRHIA)", "Model Collaboration"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Final Score:** 0.0
- **Decision:** exclude
- **Evidence Excerpt:** Weak-to-Strong Attacking via Model Collaboration: A survey
