...
authors: ["He, Haoran", "Zhou, Fanqin", "Zhao, Yikun", "Li, Wenjing", "Feng, Lei"]
year: 2023
...
pages: ""
keywords: ["Aerial base station (AeBS)", "Hypergraph convolution (HGCN)", "Multi-agent deep reinforcement learning (MADRL)", "Value decomposition, energy efficiency optimization"]
language: "English"
source:
  databases: ["Scopus"]
...
# paper-607 — Hypergraph convolution mix DDPG for multi-aerial base station deployment

## Metadata

- **Authors:** He, Haoran and Zhou, Fanqin and Zhao, Yikun and Li, Wenjing and Feng, Lei
- **Year:** 2023
- **Venue:** Journal of Cloud Computing
- **DOI:** 10.1186/s13677-023-00556-x
- **URL:** https://www.scopus.com/pages/publications/85178945637?origin=resultslist
...
- **Final Score:** 0.3333
- **Decision:** exclude
- **Evidence Excerpt:** Hypergraph convolution mix DDPG for multi-aerial base station deployment
