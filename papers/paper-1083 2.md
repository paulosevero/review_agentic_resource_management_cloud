...
authors: ["Manish, Vazzula", "Manchala, Yugandhar", "Vijayalata, Y.", "Chopra, Sudeep Banerjee", "Reddy, Kothi Yashwanth"]
year: 2024
...
pages: ""
keywords: ["Applicant Tracking Systems (ATS)", "Automated Re-sume Parsing", "Deep Learning (DL)", "Human Resources (HR)", "Large Language Model(LLM)", "Natural Lan-guage Processing (NLP)", "Software as a Service (SaaS)"]
language: "English"
source:
  databases: ["Scopus"]
...
- **Authors:** Manish, Vazzula and Manchala, Yugandhar and Vijayalata, Y. and Chopra, Sudeep Banerjee and Reddy, Kothi Yashwanth
- **Year:** 2024
- **Venue:** 2024 IEEE Region 10 Symposium, TENSYMP 2024
- **DOI:** 10.1109/TENSYMP61132.2024.10752300
- **URL:** https://www.scopus.com/pages/publications/85211905334?origin=resultslist
...
- **Final Score:** 0.5
- **Decision:** exclude
- **Evidence Excerpt:** Optimizing Resume Parsing Processes by Leveraging Large Language Models
